...
if(isset($_POST['patienttransindate'])) {$patienttransindate=$_POST['patienttransindate'];}else {$patienttransindate="";}
if(isset($_POST['currentlybreastf'])) {$currentlybreastf=$_POST['currentlybreastf'];}else {$currentlybreastf="";}

if(isset($_POST['other_art_start_stat'])) {$other_art_start_stat = implode(", ", $_POST['other_art_start_stat']);} else {$other_art_start_stat = "";}
if(isset($_POST['careentrypoint']) && $_POST['careentrypoint']!='Others') {$careentrypoint=$_POST['careentrypoint'];}elseif(isset($_POST['careentrypoint'])&& $_POST['careentrypoint']=='Others'){$careentrypoint=$_POST['careentrypointo'];}else{$careentrypoint='';}
?>
