...
class MyClass{
	...
	$role=$_GET['username'];
$query = "SELECT * from members where username='$role'";
...
<h1 style="background-color:#0F0;font-weight: 600;    font-family: 'Titillium Web', sans-serif;  position: relative;   font-size: 32px; line-height: 15px; padding: 15px 15px 15px 15%;    color: #355681;    box-shadow:         inset 0 0 0 1px rgba(53,86,129, 0.4),         inset 0 0 5px rgba(53,86,129, 0.5),        inset -285px 0 35px white;    border-radius: 0 10px 0 10px;    background: #fff url(./images/bartoszkosowski.jpg) no-repeat center left;">FIND PATIENT - PEDIATRIC</h1>
<?php

if ($info['role']=='Lab'){
echo '<a href="dtentryportlab.php?role='.$role.'">[MAIN MENU]</a>&nbsp; &nbsp; &nbsp; &nbsp;'; 
}
elseif ($info['role']=='Pharm'){
echo '<a href="dtentryportpharm.php?role='.$role.'">[MAIN MENU]</a>&nbsp; &nbsp; &nbsp; &nbsp;'; 
}

?>

<div id="stylized" class="myform">
<form id="form" name="form" method="GET" action="patpharmviewph.php">
...
<label for="pepid">PEPID
</label>
<input type="text" name="pepid" id="pepid" required class="form_element" maxlength="11" autocomplete="off" onchange="pedpepidtest()" style="width:80px; height:10px;"/>
<span id="availability_status"></span> </div>
</fieldset>
<button class="blue" type="submit"><img src="images/search.png" /></button>
<div class="spacer"></div>
<input type="hidden" name="role" id="role" value="<?php echo $info['role']?>" style="width:120px; height:20px;" readonly/>
<input type="hidden" name="userid" id="userid" value="<?php echo $info['username']?>" style="width:120px; height:20px;" readonly/>
