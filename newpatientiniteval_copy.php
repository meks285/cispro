...
<div style="width: 300px; display: table-cell;"> 
<fieldset>
<legend style="font-weight:bold; font-size:11px">12. Where does the patient live:</legend>
<label>Address
</label>
...
<legend style="font-weight:bold; font-size:11px">13. Contact person/next of kin:</legend>
<label>Name
</label>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">15. Symptoms Review</legend>
...
<fieldset>
<label>
<span class="small" style="font-weight:bold">16. Patient Accessed for TB</span>
<table>
<tr>
...
<label>
<span class="small" style="font-weight:bold">17. Additional Comments</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">18. Past Medical History</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">19. Relevant Family History</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">20. Hospitilization</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">21. Drug Allergies?</span>
<table>
<tr>
...
<label>
<span class="small" style="font-weight:bold">22a. Last Menstrual Period</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">22b. Currently Pregnant</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">22c. Currently Breast Feeding</span>
</label>
<table>
<tr>
...
<td><input type="radio" name="currentlybreastf" value="Uncertain" <?php if ($info['currentlybreastf']=='Uncertain') { echo 'checked'; } ?>/>Uncert</td>
</tr>
</table>

<label>
<span class="small" style="font-weight:bold">22d. Gestational Age(wks)</span>
</label>
<input type="text" name="gestationalage" id="gestationalage" style="width:120px; height:10px;" value="<?php echo $info['gestationalage']?>"/>

<label>
<span class="small" style="font-weight:bold">22e. Expected Date of Delivery</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">23. Latest CD4(cells/mL)</span>
</label>
...
<label>
<span class="small"style="font-weight:bold">24. Latest VL(c/ml)</span>
</label>
...
<label>25. Previous ARV Exposure</label><br>
...
<label>
<span class="small" style="font-weight:bold">25a.Name of facility</span>
</label>
<input type="text" name="prevfacilityname" id="prevfacilityname" style="width:120px; height:10px;" value="<?php echo $info['prevfacilityname']?>"/>
     ...
     <label>
<span class="small" style="font-weight:bold">25b. Duration of Care(From):</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">25b. Duration of Care(To):</span>
</label>
...
<legend style="font-weight:bold; font-size:11px">26. Current Medications</legend>
<div class="checkbox-toolbar">
<table>
<tr>
...
<table>
<tr>
<input type="text" name="otherspec" id="otherspec" style="width:120px; height:10px;" placeholder="Others" value="<?php echo $info['otherspec']?>"/>
</tr>
</table>
     </fieldset> 
         </div>      
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
       <fieldset>
<legend style="font-weight:bold; font-size:11px">27. Adherence: Complete if patient has recieved ART before coming to this facility</legend>
        <div style="width: 250px; display: table-cell;"> 
        <fieldset>
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        ...
        <legend style="font-weight:bold; font-size:11px">28. Patient has disclosed status to:</legend>
<div class="checkbox-toolbar">
<table>
<tr>
...
></td>
        ...
        <div style="display: table-cell;"> 
        <fieldset style="border:none">
        <legend style="font-weight:bold; font-size:11px">29. HIV status can be discussed with</legend>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">30. Past or current ARV side effects</legend>
<div class="checkbox-toolbar">
<table>
<label></label>
<tr>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">32. Assessment</legend>
<div class="radio-toolbar"> 
<table>
<label></label>
<tr>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">33. WHO Staging criteria(History of any of the following)</legend>
...
<legend style="font-weight:bold; font-size:11px">34. WHO Stage</legend>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">35. Plan (specify orders on requisition)</legend>
<div class="checkbox-toolbar"> 
<table>
<label></label>
<tr>
...
<tr>
<td><input type="checkbox" name="plan[]" id="plan" value="TB Investigation" <?php if (strpos($info['plan'],'TB Investigation') !== false) { echo 'checked'; }?>/>Investigate for TB</td>
...
<td><input type="checkbox" name="plan[]" id="plan" value="Symptomatic treatment/Pain control" <?php if (strpos($info['plan'],'Symptomatic treatment/Pain control') !== false||strpos($info['plan'],'Psychosocial counseling') !== false) { echo 'checked'; }?>>Pain Control</td>
<td><input type="text" name="planpain" id="planpain"  style="height:10px; width:80px" value="<?php echo $info['planpain']?>"/></td>
</tr>
<tr>
<td><input type="checkbox" name="plan[]" id="plan" value="Adherence Counseling" <?php if (strpos($info['plan'],'Adherence Counseling') !== false||strpos($info['plan'],'Adherence counseling') !== false) { echo 'checked'; }?>/>Adh Counseling</td>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">36. Enroll in:</legend>
<div class="radio-toolbar"> 
<table>
<label></label>
<tr>
<td><input type="radio" name="enrollin" value="General Medical Follow up" <?php if ($info['enrollin']=='General Medical Follow up'||$info['enrollin']=='Continuing ART') { echo 'checked'; } ?>>Medical Followup</td>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">37. Plan for ARV Therapy</legend>
<div class="radio-toolbar"> 
<table>
<label></label>
<tr>
<td><input type="radio" name="planarvtherapy" value="Continue current treatment" <?php if ($info['planarvtherapy']=='Continue current treatment'||$info['planarvtherapy']=='Stable, continue present management') { echo 'checked'; } ?>>Continue current treatment</td>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">38. a. Regimen</legend>
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        <div style="width: 200px; display: table-cell;"> 
        <fieldset style="border:none">
...
<legend style="font-weight:bold; font-size:11px">39. b. Drugs in Regimen</legend>
...
<fieldset >  
<legend style="font-weight:bold; font-size:11px">40. Next Appointment?</legend>
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        <div style="width: 250px; display: table-cell;"> 
        <fieldset style="border:none">
