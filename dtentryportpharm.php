...
<tr>
<td>
<a href="./patsearcha.php?username=<?php if(isset($_GET["username"])){ echo $_GET["username"];} elseif(isset($_GET["role"])){ echo $_GET["role"];} ?>" 
style="font-weight:bold; font-size:14px">ADULT</a> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="./patsearchpd.php?username=<?php if(isset($_GET["username"])){ echo $_GET["username"];} elseif(isset($_GET["role"])){ echo $_GET["role"];} ?>" style="font-weight:bold; font-size:14px">PEDIATRIC</a>
</td>
<td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="./totalpatientlist.php?username=<?php if(isset($_GET["username"])){ echo $_GET["username"];} elseif(isset($_GET["role"])){ echo $_GET["role"];} ?>" style="font-weight:bold; font-size:14px">PATIENT LIST</a>
</td>
...
<input name="myusername" type="hidden" id="myusername" class="form_element" value="<?php if(isset($_GET["username"])){ echo $_GET["username"];} elseif(isset($_GET["role"])){ echo $_GET["role"];} ?>" />
