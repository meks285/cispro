...
$query = "SELECT p.pepid,p.agemonth, p.uniqueid,p.hospitalid,p.surname,p.othernames,p.hivposdate,p.age,p.sex,p.lga,p.state,p.facilityname,p.ancno,p.dob,p.maritalstatus,p.educationallevel,p.jobstatus,p.address,
...
FROM patient p LEFT OUTER JOIN laboratory l
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">Patient's ART Status</span>
</label>
<div> 
<table>
<tr>
...
<td><input type="radio" name="artstatus" value="ART" />ART</td>
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">Specimen Collection Date</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">Age</span>
</label>
<table>
<tr>
<td><input type="text" name="agecalc" id="agecalc" value="<?php echo $info['age']?>" disabled="disabled" style="width:50px;height:10px;"/></td>
<td><input type="text" name="agecalc" id="agecalc" value="<?php echo $info['agemonth']?>" placeholder="In Months" style="width:50px;height:10px;"/></td>
</tr>
</table>
        </fieldset>
         </div>
