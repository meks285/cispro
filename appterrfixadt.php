...
$pepid = $_GET['pepid'];
$pepid;
$result = mysqli_query($con,"SELECT pepid,visitdate, nextapptdate
from pharmacy 
where pepid='$pepid' and nextapptdate='0000-00-00'
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="getpatientpep.php?pepid=' . $row['pepid'] . '&amp;visitdate=' . $row['visitdate'] . '">FIX</a></td>';
  ...
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="pedpatientbrowsepep.php?pepid=' . $row['pepid'] . '&amp;visitdate=' . $row['visitdate'] . '">FIX</a></td>';
  echo "<td>" . $row['pepid'] . "</td>";
  echo "<td>" . $row['visitdate'] . "</td>";
  echo "<td>" . $row['nextapptdate'] . "</td>";
 echo "</tr>";
...
echo "Total DRUG-PICKUP Errors: ".$num;
