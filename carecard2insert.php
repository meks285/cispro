...
if(isset($_POST['bmi_muac'])) {$bmi_muac=$_POST['bmi_muac'];}else {$bmi_muac = "";}
if(isset($_POST['pregnancybfstat'])) {$pregnancybfstat=$_POST['pregnancybfstat'];}else {$pregnancybfstat = "";}
if(isset($_POST['edddate'])) {$edddate=$_POST['edddate'];}else {$edddate = "";}

if(isset($_POST['sideeff'])) {$sideeff = implode(", ", $_POST['sideeff']);} else {$sideeff = "";}
if(isset($_POST['otheroi'])) {$otheroi = implode(", ", $_POST['otheroi']);} else {$otheroi = "";}
if(isset($_POST['regadherenceb'])) {$regadherenceb = implode(", ", $_POST['regadherenceb']);} else {$regadherenceb = "";}
if(isset($_POST['cotrimadherenceb'])) {$cotrimadherenceb = implode(", ", $_POST['cotrimadherenceb']);} else {$cotrimadherenceb = "";}


// =============== code for Submit_input type ================================
$query1="SELECT * from clinicaleval where pepid='$_POST[pepid]' and visitdate='$visitdate'";
...
clinician,pepid,visitdate,tbdose,tbadherencea,tbadherenceb,otherregimen,cd4value,vlvalue,otherdiag,bmi_muac,pregnancybfstat,edddate)
...
'$otherdrugs','$vlscheduled','$cd4scheduled','$othertests','$recommendation','$nextapptdate','$clinician','$_POST[pepid]','$visitdate','$tbdose','$tbadherencea','$tbadherenceb','$otherregimen','$cd4value','$vlvalue','$otherdiag','$bmi_muac','$pregnancybfstat','$edddate')"))
...
$sql="INSERT into AUDIT_TRAIL (server_name,user_name,action) VALUES('$_SERVER[REMOTE_ADDR]','$_SESSION[login_id]','NEW - Care Card.: $_POST[pepid]')";
