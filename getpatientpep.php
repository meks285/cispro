...
<form id="form" name="form" method="POST" action="getpatientupdatepep.php">
...
<input type="hidden" name="created_on" id="created_on" placeholder="YYYY-MM-DD" required value="<?php echo date("Y-m-d", strtotime($info['created_on']))?>" style="width:120px; height:10px;"/>
...
<input type="hidden" name="idpatient" id="idpatient" required="required" placeholder="Required" value="<?php echo $info['idpatient']?>" onchange="adtpepid()" style="width:120px; height:10px; font-weight:bold" />
...
<table>
<tr>
<td><input type="radio" name="sex" id="sexmale" value="male" <?php if ($info['sex']=='male') { echo 'checked'; } ?> required onchange="anccheck()" />Male</td>
<td><input type="radio" name="sex" id="sexfemale" value="Female" <?php if ($info['sex']=='Female') { echo 'checked'; } ?> required onchange="anccheck()"/>Female</td>
</tr>
</table>
...
<input type="date" name="dob" id="dob" required value="<?php echo $info['dob']?>" placeholder="Required" onChange="validateAge()" style="width:118px;height:10px;"/> 
