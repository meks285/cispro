...
if ($pmtctarvdates=='1970-01-01'){
	$pmtctarvdates='0000-00-00';
}
else{
	$pmtctarvdates;
}
...
if ($pcr6wksdates=='1970-01-01'){
	$pcr6wksdates='0000-00-00';
}
else{
	$pcr6wksdates;
}
$pcr12mthsdates = date('Y-m-d',strtotime($pcr12mthsdate));
if ($pcr12mthsdates=='1970-01-01'){
	$pcr12mthsdates='0000-00-00';
}
else{
	$pcr12mthsdates;
}
$pcr18mthsdates = date('Y-m-d',strtotime($pcr18mthsdate));
if ($pcr18mthsdates=='1970-01-01'){
	$pcr18mthsdates='0000-00-00';
}
else{
	$pcr18mthsdates;
}
