...
$pepid = $_GET['pepid'];
$pepid;
$result = mysqli_query($con,"SELECT pepid,enroldate, surname,othernames,dob,hivposdate, age, sex,created_on
from patient 
where pepid='$pepid'
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="getpatientpep.php?pepid=' . $row['pepid'] . '&amp;surname=' . $row['surname'] . '">VIEW</a></td>';
  ...
  echo "<td>" . $row['hivposdate'] . "</td>";
  echo "<td>" . $row['created_on'] . "</td>";
  echo "</tr>";
	  }
	  else {
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="pedpatientbrowsepep.php?pepid=' . $row['pepid'] . '&amp;surname=' . $row['surname'] . '">VIEW</a></td>';
  echo "<td>" . $row['pepid'] . "</td>";
  echo "<td>" . $row['surname'] . "</td>";
  echo "<td>" . $row['othernames'] . "</td>";
  echo "<td>" . $row['dob'] . "</td>";
