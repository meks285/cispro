...
<button class="button button-block"><a href="./ndr/index.php?username=<?php if(isset($_GET["username"])) echo $_GET["username"]; ?>" style="font-weight:bold; font-size:14px; color:blue; background-color:white">NDR</a></button>
</div>
</form>
</div>
