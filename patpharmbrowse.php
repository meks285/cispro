...
p.phoneno,b.patienttype,b.visittype, b.visitdate,b.pharmregno,b.regduration1,b.regduration2,b.regduration3,b.regduration4,b.weight,b.height,b.pregyn,b.refillyn,b.subswitch,b.drugname1,b.drugdose1,b.drugno1,b.drugsource1,b.drugname2,b.drugdose2,b.drugno2,b.drugsource2,b.drugname3,b.drugdose3,b.drugno3,b.drugsource3,b.oidrug,b.oiqty,b.oiduration,b.tbdrug,b.tbqty,b.tbduration,b.otherdrugs,b.otherquantity,b.otherduration,b.otherdrugs1,b.otherquantity1,b.otherduration1,b.otherdrugs2,b.otherquantity2,b.otherduration2,b.orderedby,b.orderdate,b.dispensedby,b.pharmdispensedate,b.counseledby,b.counseldate,b.pickedupby,b.pickupdate,b.errorconsequence,b.errordrugname,b.errornature,b.errorrepdate, b.nextapptdate
...
<td><input tabindex="disable" type="text" name="drugcode1a" id="drugcode1a" value="<?php echo $info['drugname1']?>" onChange="update11();" style="color:#F00; font-style:italic; width:120px; height:30px" list="DrugName" />
...
<td><input tabindex="disable" type="text" name="drugcode1b" id="drugcode1b" value="<?php echo $info['drugdose1']?>"onChange="update11();"  style="width:120px; height:30px"/></td>
<td><input tabindex="disable" type="text" name="drugcode1c" id="drugcode1c" value="<?php echo $info['drugno1']?>" onChange="update11();"  style="width:120px; height:30px"/></td>
<td><input tabindex="disable" type="text" name="drugcode1d" id="drugcode1d" value="<?php echo $info['drugsource1']?>"onChange="update11();"  style="width:120px; height:30px"/></td>
<td><select name="regduration1" id="regduration1" style="height:30px; width:70px">
	<option value="<?php echo $info['regduration1']; ?>"><?php echo $info['regduration1']; ?></option> 
...
<label id="a5b" style="color:#F00; font-style:italic;"></label>
<td><input type="text" name="drugcode2a" id="drugcode2a" value="<?php echo $info['drugname2']?>" onChange="update11();" style="color:#F00; font-style:italic;width:120px; height:30px" list="DrugName" />
<datalist id="DrugName">
    <option value="..." label="Adult 1st Line Regimens:"></option>
    <option value="AZT/3TC/EFV">AZT/3TC/EFV</option>
    <option value="AZT/3TC/NVP">AZT/3TC/NVP</option>
...
<td><input type="text" name="drugcode2b" id="drugcode2b" value="<?php echo $info['drugdose2']?>" onChange="update11();"  style="width:120px; height:30px"/>
</td>
<td><input type="text" name="drugcode2c" id="drugcode2c" value="<?php echo $info['drugno2']?>" onChange="update11();"  style="width:120px; height:30px"/>
</td>
<td><input type="text" name="drugcode2d" id="drugcode2d" value="<?php echo $info['drugsource2']?>" onChange="update11();"  style="width:120px; height:30px"/>
</td>
<td><select name="regduration2" id="regduration2" style="height:30px; width:70px">
	<option value="<?php echo $info['regduration2']; ?>"><?php echo $info['regduration2']; ?></option> 
    <option value="0.25">1 WK</option> 
    <option value="0.5">2 WKS</option>
    <option value="0.75">3 WKS</option>
    <option value="1">1 MTH</option>
...
<label id="a5b" style="color:#F00; font-style:italic;"></label>
<td><input type="text" name="drugcode3a" id="drugcode3a" value="<?php echo $info['drugname3']?>" onChange="update11();" style="color:#F00; font-style:italic;width:120px; height:30px" list="DrugName" >
<datalist id="DrugName">
    <option value="..." label="Adult 1st Line Regimens:"></option>
    <option value="AZT/3TC/EFV">AZT/3TC/EFV</option>
    <option value="AZT/3TC/NVP">AZT/3TC/NVP</option>
...
<td><input type="text" name="drugcode3b" id="drugcode3b" value="<?php echo $info['drugdose3']?>" onChange="update11();"  style="width:120px; height:30px"/></td>
<td><input type="text" name="drugcode3c" id="drugcode3c" value="<?php echo $info['drugno3']?>" onChange="update11();"  style="width:120px; height:30px"/></td>
<td><input type="text" name="drugcode3d" id="drugcode3d" value="<?php echo $info['drugsource3']?>" onChange="update11();"  style="width:120px; height:30px"/></td>
<td><select name="regduration3" id="regduration3" style="height:30px; width:70px">
	<option value="<?php echo $info['regduration3']; ?>"><?php echo $info['regduration3']; ?></option> 
    <option value="0.25">1 WK</option> 
    <option value="0.5">2 WKS</option>
    <option value="0.75">3 WKS</option>
    <option value="1">1 MTH</option>
...
<select name="oidrug">
	<option value="<?php echo $info['oidrug']?>"><?php echo $info['oidrug']?></option> 
...
<select name="oiqty">
	<option value="<?php echo $info['oiqty']?>"><?php echo $info['oiqty']?></option> 
...
<select name="oiduration">
	<option value="<?php echo $info['oiduration']." Months"?>"><?php echo $info['oiduration']." Months"?></option> 
...
<fieldset style="width:733px; height:85px">
<div  class="check-toolbar">
<tr>
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="INH" <?php if (strpos($info['tbdrug'],'INH') !== false) { echo 'checked'; }?> >INH</td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="Rifampicin" <?php if (strpos($info['tbdrug'],'Rifampicin') !== false) { echo 'checked'; }?> >Rifampicin</td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="Ethambutol" <?php if (strpos($info['tbdrug'],'Ethambutol') !== false) { echo 'checked'; }?> >Ethambutol </td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="Streptomycin Injection" <?php if (strpos($info['tbdrug'],'Streptomycin Injection') !== false) { echo 'checked'; }?> >Streptomycin Injection</td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="PZI" <?php if (strpos($info['tbdrug'],'PZI') !== false) { echo 'checked'; }?> >PZI </td><br />
</tr>
</table>
</div>
</fieldset>
...
<select name="tbqty">
	<option value="<?php echo $info['tbqty']?>"><?php echo $info['tbqty']?></option> 
    <option value="300mg">300mg</option> 
...
<select name="tbduration">
	<option value="<?php echo $info['tbduration']." Months"?>"><?php echo $info['tbduration']." Months"?></option> 
    <option value="1 month">1 month</option> 
    <option value="2 months">2 months</option> 
    <option value="3 months">3 months</option>
    <option value="4 months">4 months</option>
