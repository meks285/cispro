...
<br />
<br />
<form class="myform" id="qbuild" name="qbuild" method="GET" action="apptsearchdate.php">
<table>
<tr>
<th><label for="buildq" >Start</label><input type="date" name="buildq" id="buildq" required autocomplete="off"  style="width:120px; height:10px;"/></th>
</tr>
<tr>
<th><label for="buildq" >End</label><input type="date" name="buildy" id="buildy" required autocomplete="off"  style="width:120px; height:10px;"/></th>
</tr>
</table>
</textarea>
...
from clinicaleval
where nextapptdate between '$buildq' and '$buildy'
order by visitdate";
...
from LABORATORY
where DATE_ADD(visitdate, INTERVAL 1 YEAR) between '$buildq' and '$buildy' and lower(tests)='viral load'
order by visitdate desc";
$result1=mysql_query($query1) or die("Unidentified Pepid!");
if($result1 === FALSE) { 
    die(mysql_error()); // TODO: better error handling
...
$query1 = "select 'LAB ORDER' as CD4,pepid, visitdate as LAST_CD4_DATE, DATE_ADD(visitdate, INTERVAL 6 MONTH) as NEXT_APPOINTMENT_DATE
from LABORATORY
where DATE_ADD(visitdate, INTERVAL 6 MONTH) between '$buildq' and '$buildy' and lower(tests)='cd4'
order by visitdate desc";
$result1=mysql_query($query1) or die("Unidentified Pepid!");
if($result1 === FALSE) { 
    die(mysql_error()); // TODO: better error handling
