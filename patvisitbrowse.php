...
<?php  echo '<a style="color:blue" href="patvisitview.php?pepid=' . $info['pepid'] . '&username=' . $_GET['username'] .'">[BACK]</a>'; ?>
</div>
<body onLoad="bmicalc()">
<div id="stylized" class="myform">
<form class="well-home span6 form-horizontal" name="form" onkeypress="return event.keyCode != 13;" id="form1" method="POST" action="visitupdate.php">
