...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMImp\\Demographics.csv' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMImp\\Pharmacy.csv' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMImp\\Laboratory.csv' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMImp\\Entry.csv' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMImp\\Visit.csv' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMPIMP\\DemographicsP.csv' 
INTO TABLE apindb.patient 
FIELDS TERMINATED BY ',' 
OPTIONALLY ENCLOSED BY '"' ESCAPED BY "\\"
LINES TERMINATED BY '\r\n' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMPIMP\\PharmacyP.csv' 
INTO TABLE apindb.pharmacy 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' ESCAPED BY "\\"
LINES TERMINATED BY '\r\n' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMPIMP\\LaboratoryP.csv' 
INTO TABLE apindb.forlabcispro 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' ESCAPED BY "\\"
LINES TERMINATED BY '\r\n' 
...
LOAD DATA LOCAL INFILE 'C:\\CiS_Pro_Backups\\FMPIMP\\ClinicalEvalP.csv' 
INTO TABLE apindb.clinicaleval 
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' ESCAPED BY "\\"
LINES TERMINATED BY '\r\n' 
