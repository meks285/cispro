<?php
 ////////////////////CREATE backup FOLDER/////////////
	if (!file_exists('C:\CIS_PRO_FILES\CiS_Pro_Backups')) {
    mkdir('C:\CIS_PRO_FILES\CiS_Pro_Backups', 0777, true);
	}
...
<h1 style="background-color:#0F0;font-weight: 600;    font-family: 'Titillium Web', sans-serif;  position: relative;   font-size: 32px; line-height: 15px; padding: 15px 15px 15px 15%;    color: #355681;    box-shadow:         inset 0 0 0 1px rgba(53,86,129, 0.4),         inset 0 0 5px rgba(53,86,129, 0.5),        inset -285px 0 35px white;    border-radius: 0 10px 0 10px;    background: #fff url(../images/bartoszkosowski.jpg) no-repeat center left;">MAINTAINANCE - BACKUP</h1>
<body>
<a style="color: red;font-weight:bold" href="../index.php" >LOGOUT</a>
<div id="stylized1" class="myform">
</div>
<br>
<div id="stylized" class="myform">
<p>BACKUP: Always check for confirmation at "C:\CIS_PRO_FILES\CiS_Pro_Backup</p>
<a style="color: blue;font-weight:bold" href="?run=true">BACKUP!</a>
<?php
error_reporting(0);
if ($_GET['run']) {
  # This code will run if ?run=true is set.
 
  shell_exec("C:\wamp64\www\apindb\BACKUP\CiSProBackup.bat");
  echo "<br />";
...
<br />
<div id="stylized" class="myform">
<p>Restore: Make sure all FMPro Exports have been converted to .csv of same name @ "C:\FMImp"</p>
<a style="color: blue;font-weight:bold" href="?res=true">RESTORE!</a>
<?php
error_reporting(0);
if ($_GET['res']) {
  # This code will run if ?res=true is set.
  	
  shell_exec("C:\wamp64\www\apindb\BACKUP\CiSProRest.bat");
  echo "<br />";
