...
if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM `exposed_infant` LIKE '".$column14."'"))==0){
  ...
  `age_first_dna_pcr` date DEFAULT NULL,
...
if(noofdeliveries == "" || noofdeliveries==null){
...
<a href="exposedinfantz.php?username=<?php if(isset($_GET["username"])) echo $_GET["username"]; ?>" style="font-weight:bold; font-size:14px; color:#ffffff;font-family: 'Titillium Web', sans-serif;">BLANK EI FORM</a> <br>
</fieldset>
<hr />
...
<h3 style="text-align:center">Z-BABIES</h3>
<span id="status"></span>

<h3 style="text-align:center">EXPOSED INFANT</h3>
<table class="table table-bordered table-hover">
<tr><td style="width:20px;"></td>
<td><b>PMTCT ID (Not required for Z-babies)</b></td><td><input type="hidden" name="pmtct_id" id="pmtct_id" value="<?php if(isset($_GET['pmtctid'])){echo $_GET['pmtctid'];} ?>" style="width:120px;height:10px;" onfocus="emptyElement('status','status3')" required></td>
</tr>
<tr><td style="width:20px;"></td>
<td><b>Visit Date</b></td><td><input type="date" name="visitdate" id="visitdate"  style="width:120px;height:10px;" onfocus="emptyElement('status','status3')" required></td></tr>
...
<fieldset>
 ...
 <input type="radio" onfocus="emptyElement('status','status3')" name="hiv_neg_breastfd_st" value="Unknown">Unknown</fieldset>
 <br/>
