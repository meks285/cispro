...
<td>
Age
<input type="text" value="<?php echo $info['gest_age_art']; ?>" name="gest_age_art" onfocus="emptyElement('status','status3')" id="gest_age_art"  style="width:120px;"/>
</td>
</tr>
