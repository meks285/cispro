...
class MyClass{
	...
	$column16 = 'motherbaby_pairreffered';
	$column17 = 'motherbaby_pairreffered_date';
	$column18 = 'motherbaby_pairreffered_age';
...
if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM `exposed_infant` LIKE '".$column14."'"))==0){
	...
	// Addition of Multiple New Columns
if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM `exposed_infant` LIKE '".$column15."'"))==0){
	$results_C1 = mysql_query("ALTER TABLE exposed_infant
	ADD COLUMN syrup_zdv varchar(50) DEFAULT NULL;");
	}
	
	// Addition of Multiple New Columns
if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM `exposed_infant` LIKE '".$column16."'"))==0){
	$results_C1 = mysql_query("ALTER TABLE exposed_infant
	ADD COLUMN motherbaby_pairreffered varchar(50) DEFAULT NULL;");
	}
	// Addition of Multiple New Columns
if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM `exposed_infant` LIKE '".$column17."'"))==0){
	$results_C1 = mysql_query("ALTER TABLE exposed_infant
	ADD COLUMN motherbaby_pairreffered_date varchar(50) DEFAULT NULL;");
	}
	// Addition of Multiple New Columns
if(mysql_num_rows(mysql_query("SHOW COLUMNS FROM `exposed_infant` LIKE '".$column18."'"))==0){
	$results_C1 = mysql_query("ALTER TABLE exposed_infant
	ADD COLUMN motherbaby_pairreffered_age varchar(50) DEFAULT NULL;");
	}
  ...
  `motherbaby_pairreffered` varchar(50) DEFAULT NULL,
  `motherbaby_pairreffered_date` varchar(50) DEFAULT NULL,
  `motherbaby_pairreffered_age` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
)");
...
var age_first_dna_pcr = _("age_first_dna_pcr").value
			...
			var rates28 = document.getElementsByName('months_eid_ordered');
				...
				var rates29 = document.getElementsByName('hiv_neg_breastfd_st');
				...
				///new 13/03/2017
				var syrup_zdv;
				var rates30 = document.getElementsByName('syrup_zdv');
				for(var i = 0; i < rates30.length; i++){
					if(rates30[i].checked){
						syrup_zdv = rates30[i].value;
					}
				}
				
				var motherbaby_pairreffered;
				var rates31 = document.getElementsByName('motherbaby_pairreffered');
				for(var i = 0; i < rates31.length; i++){
					if(rates31[i].checked){
						motherbaby_pairreffered = rates31[i].value;
					}
				}
				
				var motherbaby_pairreffered_date = _("motherbaby_pairreffered_date").value;
				var motherbaby_pairreffered_age = _("motherbaby_pairreffered_age").value;
...
}else if(syrup_zdv == "" || syrup_zdv ==null ){
status.innerHTML = "<div id=\"error\">Please complete syrup zdv!</div>";
status3.innerHTML = "<div id=\"error\">Please complete syrup zdv!</div>";
}else if(motherbaby_pairreffered == "YES" && motherbaby_pairreffered_age == "" ){
status.innerHTML = "<div id=\"error\">Please complete Mother baby pair reffered!</div>";
status3.innerHTML = "<div id=\"error\">Please complete Mother baby pair reffered!</div>";
...
function clearfields(){
   ...
   for(var i=0;i<elesyrup_nvp.length;i++){
	  ...
	  var elesyrup_zdv = document.getElementsByName("syrup_zdv");
   for(var i=0;i<elesyrup_zdv.length;i++){
      elesyrup_zdv[i].checked = false;}
...
function checkAgeReffered(){
	var oneDay = 24 * 3600 * 1000;
	var d1 = document.getElementById("infant_date_of_birth").value;
	var d2 = document.getElementById("motherbaby_pairreffered_date").value;
	...
	document.getElementById("motherbaby_pairreffered_age").value = diffDays;
...
<tr><td style="width:20px;">24</td>
<td><b>PMTCT Transition Status</b></td>
<td>
<div>Mother baby pair reffered</div>
 <input type="radio" name="motherbaby_pairreffered" onfocus="emptyElement('status','status3')" value="YES">YES &nbsp;&nbsp;
 <input type="radio" name="motherbaby_pairreffered" onfocus="emptyElement('status','status3')" value="NO">NO
 &nbsp; &nbsp;
  Date<input type="date" onfocus="emptyElement('status','status3')" onblur="checkAgeReffered()" name="motherbaby_pairreffered_date" id="motherbaby_pairreffered_date"  style="width:120px;"/>
  &nbsp; &nbsp;
  Age of Infant at refferal<input type="text" onfocus="emptyElement('status','status3')" name="motherbaby_pairreffered_age" id="motherbaby_pairreffered_age"  style="width:30px;"/>
</td>
</tr>
