...
<?php if ($info['motherbaby_pairreffered'] == "YES"){ ?>
 <input type="radio" checked="checked" name="motherbaby_pairreffered" onfocus="emptyElement('status','status3')" value="YES">YES &nbsp;&nbsp;
 <input type="radio" name="motherbaby_pairreffered" onfocus="emptyElement('status','status3')" value="NO">NO
 &nbsp; &nbsp;
  Date<input type="date" onfocus="emptyElement('status','status3')" value="<?php echo $info['motherbaby_pairreffered_date']; ?>" onblur="checkAgeReffered()" name="motherbaby_pairreffered_date" id="motherbaby_pairreffered_date"  style="width:120px;"/>
  &nbsp; &nbsp;
  Age of Infant at refferal<input type="text" value="<?php echo $info['motherbaby_pairreffered_age']; ?>" onfocus="emptyElement('status','status3')" name="motherbaby_pairreffered_age" id="motherbaby_pairreffered_age"  style="width:30px;"/>
  <?php }?>
  
  <?php if ($info['motherbaby_pairreffered'] == "NO"){ ?>
 <input type="radio" name="motherbaby_pairreffered" onfocus="emptyElement('status','status3')" value="YES">YES &nbsp;&nbsp;
 <input type="radio" checked="checked" name="motherbaby_pairreffered" onfocus="emptyElement('status','status3')" value="NO">NO
 &nbsp; &nbsp;
  Date<input type="date" onfocus="emptyElement('status','status3')" value="" onblur="checkAgeReffered()" name="motherbaby_pairreffered_date" id="motherbaby_pairreffered_date"  style="width:120px;"/>
  &nbsp; &nbsp;
  Age of Infant at refferal<input type="text" value="" onfocus="emptyElement('status','status3')" name="motherbaby_pairreffered_age" id="motherbaby_pairreffered_age"  style="width:30px;"/>
  <?php }?>
