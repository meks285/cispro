...
<?php } ?>
 ...
 <fieldset>
 <legend>HIV Infected Linkage Status:</legend>
...
<?php } ?>
  ...
  Facility Name<input type="text" value="<?php if($info['ei_outcome_referred_facilityname'] != "" && $info['ei_outcome_referred_facilityname'] != "undefined"){echo $info['ei_outcome_referred_facilityname'];}else{echo "";} ?>" onfocus="emptyElement('status','status3')" name="ei_outcome_referred_facilityname" id="ei_outcome_referred_facilityname"  style="width:150px;"/>&nbsp; 
   ...
   <div></div>
   <?php if ($info['ei_outcome_linkedtocare'] == "Loss to follow-up"){ ?>
<input type="radio" checked="checked" onfocus="emptyElement('status','status3')" name="ei_outcome_linkedtocare" value="Loss to follow-up">Loss to follow-up
 <?php }else{ ?>
<input type="radio" onfocus="emptyElement('status','status3')" name="ei_outcome_linkedtocare" value="Loss to follow-up">Loss to follow-up
<?php } ?>

   <div></div>
   <?php if ($info['ei_outcome_linkedtocare'] == "Dead"){ ?>
<input type="radio" checked="checked" onfocus="emptyElement('status','status3')" name="ei_outcome_linkedtocare" value="Dead">Dead
 <?php }else{ ?>
<input type="radio" onfocus="emptyElement('status','status3')" name="ei_outcome_linkedtocare" value="Dead">Dead
<?php } ?>
   </fieldset>
