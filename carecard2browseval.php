...
class MyClass{
    public function GetUserInformation(){
		...
		$visitdate;
$query = "SELECT clinicaleval.clinicevalid,patient.pepid, patient.surname,patient.othernames,patient.age, patient.uniqueid,patient.sex, clinicaleval.visitdate,clinicaleval.artduration,clinicaleval.weight,clinicaleval.height,clinicaleval.bp,clinicaleval.eddpmtct,clinicaleval.fp,clinicaleval.functionalstatus,clinicaleval.whostage,clinicaleval.tbstatus,clinicaleval.otheroi,clinicaleval.sideeff,clinicaleval.regimen,clinicaleval.regadherencea,clinicaleval.regadherenceb,clinicaleval.cotrimdose,clinicaleval.cotrimadherencea,clinicaleval.cotrimadherenceb,clinicaleval.inhdose,clinicaleval.inhadherencea,clinicaleval.inhadherenceb,clinicaleval.otherdrugs,clinicaleval.cd4scheduled,clinicaleval.vlscheduled,clinicaleval.othertests,clinicaleval.recommendation,clinicaleval.nextapptdate,clinicaleval.clinician,clinicaleval.otherregimen,clinicaleval.cd4value,clinicaleval.vlvalue,clinicaleval.otherdiag
FROM patient JOIN clinicaleval
ON (patient.pepid=clinicaleval.pepid)
WHERE patient.pepid = '$_SESSION[pepid]' and clinicaleval.visitdate='$visitdate'";
...
<form id="form" name="form" onkeypress="return event.keyCode != 13;" method="POST" action="carecard2update.php">
<fieldset>
<input type="hidden" name="pepid" id="pepid" value="<?php echo $info['pepid']?>" readonly />
<input type="hidden" name="clinicevalid" id="clinicevalid" value="<?php echo $info['clinicevalid']?>" readonly />
...
<input type="date" name="visitdate" id="visitdate" value="<?php echo $info['visitdate']?>" required="required" placeholder="YYYY-MM-DD" style="width:120px; height:10px; float:left"/>
        </fieldset>
         </div>
...
<input type="text" name="artduration" id="artduration" value="<?php echo $info['artduration']?>" style="width:50px; height:10px;"/>
        </fieldset>
         </div>
    </div>
</div>
...
<input type="text" name="weight" id="weight" value="<?php echo $info['weight']?>" style="width:50px; height:10px; float:left"/>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
...
<input type="text" name="height" id="height" value="<?php echo $info['height']?>" style="width:50px; height:10px;"/>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
...
<input type="text" name="bp" id="bp" value="<?php echo $info['bp']?>" style="width:120px; height:10px;"/>
        </fieldset>
         </div>
    </div>
</div>
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        ...
        <fieldset style="height:20px; border:none">
<label>
<span  id="eddpmtctl" class="small" style="font-weight:bold">E6. EDD and PMTCT link</span>
</label>
<select name="eddpmtct" id="eddpmtct" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['eddpmtct']?>"><?php echo $info['eddpmtct']?></option> 
...
<select name="fp" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['fp']?>"><?php echo $info['fp']?></option> 
    <option value=""></option> 
...
<select name="functionalstatus" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['functionalstatus']?>"><?php echo $info['functionalstatus']?></option> 
...
<select name="whostage" id="whostage" style="width:40px; height:20px; float:left">
...
<select name="tbstatus" id="tbstatus" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['tbstatus']?>"><?php echo $info['tbstatus']?></option> 
...
<select name="otheroi" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['otheroi']?>"><?php echo $info['otheroi']?></option> 
...
<select name="sideeff" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['sideeff']?>"><?php echo $info['sideeff']?></option> 
...
<select name="regimen" id="regimen" style="width:120px; height:20px; float:left">
	<option value="<?php echo $info['regimen']?>"><?php echo $info['regimen']?></option> 
...
<select name="regadherencea">
	<option value="<?php echo $info['regadherencea']?>"><?php echo $info['regadherencea']?></option> 
...
<select name="regadherenceb">
	<option value="<?php echo $info['regadherenceb']?>"><?php echo $info['regadherenceb']?></option> 
...
<input type="text" name="cotrimdose" id="cotrimdose" value="<?php echo $info['cotrimdose']?>" id="cotrimdoze" style="width:120px; height:10px;"/>
<p></p>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
...
<select name="cotrimadherencea">
	<option value="<?php echo $info['cotrimadherencea']?>"><?php echo $info['cotrimadherencea']?></option> 
    <option value="Good">Good</option> 
    <option value="Fair">Fair</option>
    <option value="Poor">Poor</option>
</select>
...
<select name="cotrimadherenceb">
	<option value="<?php echo $info['cotrimadherenceb']?>"><?php echo $info['cotrimadherenceb']?></option> 
    <option value="Forgot">Forgot</option> 
    <option value="Fell asleep/slept through dose">Fell asleep/slept through dose</option>
    <option value="Change in routine/away from home">Change in routine/away from home</option>
    <option value="Busy/working/at school">Busy/working/at school</option> 
...
<input type="text" name="inhdose" id="inhdose" value="<?php echo $info['inhdose']?>" style="width:120px; height:10px;"/>
<p></p>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
...
<select name="inhadherencea">
	<option value="<?php echo $info['inhadherencea']?>"><?php echo $info['inhadherencea']?></option> 
    <option value="Good">Good</option> 
    <option value="Fair">Fair</option>
    <option value="Poor">Poor</option>
</select>
...
<select name="inhadherenceb">
	<option value="<?php echo $info['inhadherenceb']?>"><?php echo $info['inhadherenceb']?></option> 
    <option value="Forgot">Forgot</option> 
    <option value="Fell asleep/slept through dose">Fell asleep/slept through dose</option>
    <option value="Change in routine/away from home">Change in routine/away from home</option>
    <option value="Busy/working/at school">Busy/working/at school</option> 
...
<table>
<tr>
<td><input type="checkbox" name="cd4scheduled" id="cd4scheduled" value="Yes (CD4)" <?php if ($info['cd4scheduled']=='Yes (CD4)') { echo 'checked'; } ?> /></td>
<td><input type="text" name="cd4value" id="cd4value" size="3" style="height:10px" value="<?php echo $info['cd4value']?>" /></td>
</tr>
</table>
...
<table>
<tr>
<td><input type="checkbox" name="vlscheduled" id="vlscheduled" value="Yes (VL)" <?php if ($info['vlscheduled']=='Yes (VL)') { echo 'checked'; } ?> /></td>
<td><input type="text" name="vlvalue" id="vlvalue" size="3" style="height:10px" value="<?php echo $info['vlvalue']?>" /></td>
</tr>
</table>
...
<input type="date" name="nextapptdate" id="nextapptdate" value="<?php echo $info['nextapptdate']?>" required="required" style="width:120px; height:10px;"/>
</fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
        <label><span class="small" style="font-weight:bold">E23. Name/Signature</span></label>
<input type="text" name="clinician" id="clinician" value="<?php echo $info['clinician']?>" required="required" style="width:120px; height:10px;"/>
...
function checkFilled() {
    ...
    var artduration = document.getElementById("artduration");
    var regimen = document.getElementById("regimen");
    var eddpmtct = document.getElementById("eddpmtct");
    var cotrimdose = document.getElementById("cotrimdose");
    var inhdose = document.getElementById("inhdose");
    var cd4value = document.getElementById("cd4value");
    var tbstatus = document.getElementById("tbstatus");
    var whostage = document.getElementById("whostage");
    var vlvalue = document.getElementById("vlvalue");
    var cd4scheduled = "<?php echo $info['cd4scheduled']; ?>"; 
    var vlscheduled = "<?php echo $info['vlscheduled']; ?>"; 

//	
	    if (visitdate.value == ""|| visitdate.value == null|| visitdate.value == "0000-00-00") {
        visitdate.style.backgroundColor = "red";
    }
    else{
        visitdate.style.backgroundColor = "";
    }
//	


    if (artduration.value == ""||artduration.value == null) {
        artduration.style.backgroundColor = "red";
    }
    else{
        artduration.style.backgroundColor = "";
    }
//	
//	


    if (eddpmtct.value == ""||eddpmtct.value == null) {
        eddpmtct.style.backgroundColor = "red";
    }
    else{
        eddpmtct.style.backgroundColor = "";
    }
//	
    if (regimen.value == ""||regimen.value == null) {
        regimen.style.backgroundColor = "red";
    }
    else{
        regimen.style.backgroundColor = "";
    }
//
    if (cotrimdose.value == ""||cotrimdose.value == null) {
        cotrimdose.style.backgroundColor = "red";
    }
    else{
        cotrimdose.style.backgroundColor = "";
    }
//	
    if (inhdose.value == ""||inhdose.value == null) {
        inhdose.style.backgroundColor = "red";
    }
    else{
        inhdose.style.backgroundColor = "";
    }
//	
    if (cd4scheduled.value == ""||cd4scheduled.value == null) {
        cd4value.style.backgroundColor = "red";
    }
    else{
        cd4value.style.backgroundColor = "";
    }
//	
    if (vlscheduled.value == ""||vlscheduled.value == null) {
        vlvalue.style.backgroundColor = "red";
    }
    else{
        vlvalue.style.backgroundColor = "white";
    }
//	
    if (tbstatus.value == ""||tbstatus.value == null) {
        tbstatus.style.backgroundColor = "red";
    }
    else{
        tbstatus.style.backgroundColor = "";
    }
//	
    if (whostage.value == ""||whostage.value == null) {
