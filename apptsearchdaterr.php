...
This Platform allows you to find patients who visited at a Particular date range who were not "erronously" assigned a Next Appointment Date. Select a Range of VisitDates and Click Search
</fieldset>
<form class="myform" id="qbuild" name="qbuild" method="GET" action="apptsearchdaterr.php">
<table>
<tr>
<td><label for="buildq">START</label></td>
<td><input type="date" name="buildq" id="buildq" required autocomplete="off"  style="width:120px; height:10px;"/></td>
</tr>
<tr>
<td><label for="buildq1">END</label></td>
<td><input type="date" name="buildq1" id="buildq1" required autocomplete="off"  style="width:120px; height:10px;"/></td>
</tr>
</table>
<br />
...
class MyClass{
    public function GetUserInformation(){
		if(isset($_GET['buildq'])&&isset($_GET['buildq1'])){ 
$buildq = $_GET['buildq']; 
$buildq1 = $_GET['buildq1']; 
} 
 else {
$buildq = "";
}
...
from clinicaleval
where visitdate BETWEEN '$buildq' AND '$buildq1'
AND nextapptdate='0000-00-00'
order by visitdate";
