...
<title>CQI</title>
<h1 align="center"> Clinical Quality Indicators	- Pediatric													
</h1>
</head>
<style type="text/css">
body{
...
<?php echo $_GET['reportingyear']; ?>
 ...
 <tr>
        ...
        Percentage of eligible pediatrics (<=5 Years) that initiated ART in the last 6 months.</div></div></td>
...
ON (t.pepid=p.pepid)
where lower(visittype)='initial' AND lower(patienttype)='art' AND ROUND(DATEDIFF(t.dispensedate , p.dob)/365) <= 5 AND
...
from patient p JOIN laboratory ph
ON (ph.pepid=p.pepid)
where ROUND(DATEDIFF(p.enroldate , p.dob)/365) <= 5 AND ph.artstatus='Non-ART' AND
  p.enroldate >= DATE_ADD(LAST_DAY(DATE_SUB('2008-12-31', INTERVAL 6 MONTH)), INTERVAL 1 DAY) and
p.enroldate <= DATE_SUB('2008-12-31', INTERVAL 1 DAY)";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;font-size:24px; font-style:normal;"><?php 
...
?></div></div></td>
        ...
        ART 2</font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of eligible pediatrics (5 to 15 Years) that initiated ART in the last 6 months.</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
$query1 = "select COUNT(distinct t.pepid)
from
  pharmacy t JOIN patient p
ON (t.pepid=p.pepid)
where lower(visittype)='initial' AND lower(patienttype)='art' AND (ROUND(DATEDIFF(t.dispensedate , p.dob)/365) between 5 and 15 ) AND
  t.dispensedate >= DATE_ADD(LAST_DAY(DATE_SUB('$rdate', INTERVAL 6 MONTH)), INTERVAL 1 DAY) and
t.dispensedate <= DATE_SUB('$rdate', INTERVAL 1 DAY)";
$result1 = mysql_query($query1,$con);
...
AND (ROUND(DATEDIFF(t.visitdate , p.dob)/365) between 5 and 15) AND
...
?></div></div></td>
        ...
        <th align="left"><font color="black">
ART 3</font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of new ART pediatrics with <=50 cell/mL increase in CD4 count after 6 months on ART.</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
?></div></div></td>
        ...
        <th align="left"><font color="black">
ART 4</font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of patients initiating ART with detectable viral load after 6 months on ART.</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
CLINICAL CARE 1 </font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics with at least one (1) clinical visit in the last six (6) months
</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
CLINICAL CARE 2</font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics in HIV Care who received WHO Clinical Staging at least once in the last 6 months
</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
CLINICAL CARE 3
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of HIV-positive pediatrics receiving cotrimoxazole prophylaxis
</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
CLINICAL CARE 4
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of eligible pediatrics who received a TB clinical symptom assessment in the review period.
</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
$query1 = "select COUNT(distinct c.pepid)
FROM clinicaleval c JOIN patient p
ON (c.pepid=p.pepid)
WHERE (c.tbstatus!='' or c.tbstatus is not null) AND ROUND(DATEDIFF(c.visitdate , p.dob)/365) < 15 AND
  c.visitdate >= DATE_ADD(LAST_DAY(DATE_SUB('$rdate', INTERVAL 6 MONTH)), INTERVAL 1 DAY) and
c.visitdate <= DATE_SUB('$rdate', INTERVAL 1 DAY)";
$result1 = mysql_query($query1,$con);
echo mysql_result($result1,0);
...
CLINICAL CARE 5
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics who had height and weight monitoring in the last 6 months.
</div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
$query1 = "select COUNT(distinct c.pepid)
FROM clinicaleval c JOIN patient p
ON (c.pepid=p.pepid)
WHERE (c.weight!='' or c.weight is not null) AND (c.height!='' or c.height is not null) AND ROUND(DATEDIFF(c.visitdate , p.dob)/365) < 15 AND
  c.visitdate >= DATE_ADD(LAST_DAY(DATE_SUB('$rdate', INTERVAL 6 MONTH)), INTERVAL 1 DAY) and
c.visitdate <= DATE_SUB('$rdate', INTERVAL 1 DAY)";
$result1 = mysql_query($query1,$con);
echo mysql_result($result1,0);
...
?></div></div></td>
        ...
        <th align="left"><font color="black">
LAB 1</font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of newly enrolled pediatrics in the last six (6) months with baseline CD4 count 
</div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
$query1 = "select count(distinct c.pepid)
...
?></div></div></td>
        ...
        <th align="left"><font color="black">
LAB 2</font></th>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics who had a CD4 count in the last 6 months.
</div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
$query1 = "select count(distinct c.pepid)
FROM laboratory c JOIN patient p
...
LAB 3
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics who had a viral load test 6 months from initiation on ART</div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
t1.visitdate <= DATE_SUB('2015-05-31', INTERVAL 1 DAY) and ROUND(DATEDIFF(t1.visitdate , p.dob)/365) < 15";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
...
LAB 4
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics who had a viral load test one year from the last viral load test
</div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
$query1 = "SELECT count(distinct l1.pepid)
FROM laboratory l1
...
LAB 5
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;">Percentage of pediatrics (monthly cohort) who had detectable viral load 6 months after initiation on ART and had a repeat viral load test 3 months after that
</div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px; font-size:24px; font-style:normal;"><?php 
