...
AND ROUND(DATEDIFF(a.visitdate , p.dob)/30.4) < 12 
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) between 1 and 4
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) between 5 and 9
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) between 10 and 14
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) between 15 and 19
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) between 20 and 24
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) between 25 and 49
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from a.visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from a.visitdate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(a.visitdate , p.dob)/365,1) >= 50
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot31" style="padding-right: 3px;"></div></div></td>
</tr>   
<tr>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot32" style="padding-right: 3px;"></div></div></td>
</tr> 
        <tr>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot19" style="padding-right: 3px;"></div></div></td>
</tr>    
...
AND ROUND(DATEDIFF(v_datemin , p.dob)/30.4) < 12 AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(v_datemin , dob)/365,1) between 1 and 4
AND LOWER(p.sex) LIKE 'm%'
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(v_datemin , dob)/365,1) between 4 and 9
                                AND LOWER(p.sex) LIKE 'm%'
                                AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(v_datemin , dob)/365,1) between 9 and 14
                                AND LOWER(p.sex) LIKE 'm%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) between 14 and 19
                                AND LOWER(p.sex) LIKE 'm%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) between 19 and 24
                                AND LOWER(p.sex) LIKE 'm%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) between 24 and 49
                                AND LOWER(p.sex) LIKE 'm%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) >= 50
                                AND LOWER(p.sex) LIKE 'm%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/30.4) <= 12
                                AND LOWER(p.sex) LIKE 'f%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) between 1 and 4
                                AND LOWER(p.sex) LIKE 'f%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) between 4 and 9
                                AND LOWER(p.sex) LIKE 'f%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from v_datemin) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from v_datemin) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(b.v_datemin , dob)/365,1) between 9 and 14
                                AND LOWER(p.sex) LIKE 'f%'
AND a.patienttype NOT IN ('Occup PEP','Non-Occup PEP','PMTCT')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot7" style="padding-right: 3px;"><input type="text" name="tot7" style="width:70%;" ></div></div></td>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot21" style="padding-right: 3px;"></div></div></td>
</tr>   
<tr>
...
AND ROUND(DATEDIFF(b.v_datemax , p.dob)/30.4) < 12 
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and b.v_datemax between '$cohortdate1' and '$rdate'
and TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) + DATEDIFF(v_datemax,b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) MONTH  ) / DATEDIFF(b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) + 1 MONTH, b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) MONTH  ) >= 12
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) between 1 and 4
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and b.v_datemax between '$cohortdate1' and '$rdate'
and TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) + DATEDIFF(v_datemax,b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) MONTH  ) / DATEDIFF(b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) + 1 MONTH, b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) MONTH  ) >= 12
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) between 5 and 9
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and b.v_datemax between '$cohortdate1' and '$rdate'
and TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) + DATEDIFF(v_datemax,b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) MONTH  ) / DATEDIFF(b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) + 1 MONTH, b.v_datemin + INTERVAL TIMESTAMPDIFF(MONTH, b.v_datemin, v_datemax) MONTH  ) >= 12
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) between 10 and 14
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) between 15 and 19
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) between 20 and 24
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) between 25 and 49
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND ROUND(DATEDIFF(v_datemax , p.dob)/365,1) >= 50
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
AND ROUND(DATEDIFF(v_datemax , p.dob)/30.4) < 12
AND LOWER(p.sex) LIKE 'f%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot28" style="padding-right: 3px;"></div></div></td>
</tr>   
<tr>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot28b" style="padding-right: 3px;"></div></div></td>
</tr>               
<tr>
...
AND ROUND(DATEDIFF(l.visitdate , p.dob)/30.4) < 12 
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) between 1 and 4
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) between 5 and 9
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) between 10 and 14
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) between 15 and 19
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) between 20 and 24
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) between 25 and 49
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
and l.results < 1000
AND l.visitdate > '$rdate' - INTERVAL 12 MONTH
AND ROUND(DATEDIFF(l.visitdate , p.dob)/365,1) >= 50
AND LOWER(p.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?></div></div></td>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot29" style="padding-right: 3px;"></div></div></td>
</tr>
<tr>
...
echo mysql_result($result2,0);
?></div></div></td>
<td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div id="tot30" style="padding-right: 3px;"></div></div></td>
</tr>         
