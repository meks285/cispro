...
<form id="form" name="form" method="POST" onkeypress="return event.keyCode != 13;" action="insertped.php">
<fieldset>
...
<input type="date" name="visitdate" id="visitdate" required="required" value="<?php if(isset($_GET["visitdate"])) echo $_GET["visitdate"]; ?>" placeholder="YYYY-MM-DD" style="width:120px; height:10px; float:left"/>
        </fieldset>
         </div>
...
<input type="text" name="pepid" id="pepid" required="required" maxlength="11" value="<?php if(isset($_GET["pepid"])) echo $_GET["pepid"]; ?>" placeholder="Required" onchange=" pedpepidchk()" style="width:120px; height:10px; font-weight:bold" />
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">Hospital ID</span>
</label>
<input type="text" name="hospitalid" id="hospitalid" required="required" value="<?php if(isset($_GET["hospitalid"])) echo $_GET["hospitalid"]; ?>"  style="width:120px; height:10px; float:left"/>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
...
<td><input type="radio" name="sex" id="sexfemale" value="Female" required="required" <?php error_reporting(E_ERROR); if (($_GET["sex"])=="F"||($_GET["sex"])=="Female") { echo 'checked'; } else{} ?> onchange="anccheck()"/>Female</td>
</tr>
</table>
...
<input type="date" name="dob" required id="dob" style="width:120px;height:10px;"  value="<?php if(isset($_GET["dob"])) echo $_GET["dob"]; ?>" onchange="validateAge()"/>
      </fieldset>
         </div>
        <div style="display: table-cell; width:280px"> 
        <fieldset style="height:20px; border:none">
...
<table>
<tr>
<td><input type="radio" name="pmotheralive" id="pma_yes" value="Yes" onchange="motheralivecheck()" required="required" <?php error_reporting(E_ERROR); if (isset($_GET["pepid"])) { echo 'checked'; } else{} ?>  />Yes</td>
...
<table>
<tr>
<td><input type="radio" name="pfatheralive" id="pfa_yes" value="Yes" onchange="fatheralivecheck()" required="required" <?php error_reporting(E_ERROR); if (isset($_GET["pepid"])) { echo 'checked'; } else{} ?> />Yes</td>
