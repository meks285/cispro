...
<label for="pepid">Patient ID
</label>
<input type="text" name="pepid" id="pepid" maxlength="10" required class="form_element" autocomplete="off" onchange="pepidtest()" style="width:70px; height:10px;"/>
