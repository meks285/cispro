...
wardvillage,town,addrlga,phoneno,nokname,nokaddr,nokwardvillage,noktown,nokstate,nokrelationship,nokphoneno,enroldate,hivposdate, hivmode,careentrypoint,priorart,dateeligible,whyeligible,dateinitadh,datetransfin,facilitytransf,firstartregimen,dateartstart,clinicalstageart,peweightatart,peheightatart, cd4atart,lastcd4date,testlocation,patfunction
...
echo mysql_error();
?>
<h1 align="center" style="background-color:#0F0">CARE/ART CARD</h1>
<body >
<div class='sidebar1'>
...
<form id="form" name="form" method="POST" action="updatecaredata.php">
...
<input type="text" name="facilityname" id="facilityname" required="required" placeholder="YYYY-MM-DD" value="<?php echo $info['facilityname']?>" style="width:150px; height:10px; float:left"/>
        </fieldset>
         </div>
...
<input type="text" name="hospitalno" id="hospitalno" placeholder="YYYY-MM-DD" required value="<?php echo $info['hospitalid']?>" style="width:120px; height:10px;"/>
...
<select name="careentrypoint" id="careentrypoint" style="width:120px; height:20px;">
	<option value="<?php echo $info['careentrypoint']?>"><?php echo $info['careentrypoint']?></option> 
...
<input type="date" name="hivposdate" id="hivposdate" value="<?php echo $info['hivposdate']?>" style="width:120px;height:10px;" readonly/>
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">11. Mode of HIV </span>
</label>
...
<select name="whyeligible" id="whyeligible" style="width:120px; height:20px;">
    ...
    <option value="TLC">TLC</option>
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">16. Date initial adherence counselling completed</span>
</label>
...
<input type="text" name="clinicalstageart" id="clinicalstageart" value="<?php echo $info['clinicalstageart']?>" style="width:120px; height:10px"/>
        </fieldset>
         </div>        
         <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
...
<input type="text" name="peweightatart" id="peweightatart" value="<?php echo $info['peweightatart']?>" style="width:120px; height:10px"/>
</fieldset>
      </div>
...
<input type="text" name="peheightatart" id="peheightatart" value="<?php echo $info['peheightatart']?>" style="width:30px; height:10px"/>
        </fieldset>
         </div>        
         <div style="display: table-cell; width:300px"> 
        <fieldset style="height:20px; border:none">
...
<input type="text" name="cd4atart" id="cd4atart" value="<?php echo $info['cd4atart']?>" style="width:100px; height:10px"/>
        </fieldset>
         </div>
         <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
