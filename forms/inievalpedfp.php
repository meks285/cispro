...
//document.getElementById('doblabel').innerHTML = str1+(td1 - del_date)+"Yrs";
if (td1 - del_date < 5){
		document.getElementById('agemonth').value = ((td1 - del_date)*365.2425)/30;
		}
	}
...
<h1 align="center" style="background-color:#0F3">Paediatric Initial Clinical Evaluation Form</h1>
...
<table>
<tr>
<td><input type="radio" name="pcurrmeds" value="None" />None</td>
<td><input type="radio" name="pcurrmeds" value="ART" />ART</td>
</tr>
<tr>
<td><input type="radio" name="pcurrmeds" value="CTX" />CTX</td>
<td><input type="radio" name="pcurrmeds" value="Anti-TB" />Anti-TB</td>
</tr>
<tr>
<td><input type="radio" name="pcurrmeds" value="" />Others</td>
<td><input type="text" name="pcurrmeds" id="pcurrmeds" size="5" placeholder="others"></td>
</tr>
</table>
</div>
        </fieldset>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">38. Physical exam(note: NSF: No significant findings)</legend>
<div style="width: 100%; display: table;">
    <div style="display: table-row">
...
<table>
<tr>
<td><input type="radio" name="assessment" value="Asymptomatic" />Asymptomatic</td>
<td><input type="radio" name="assessment" value="Symptomatic" />Symptomatic</td>
<td><input type="radio" name="assessment" value="AIDS Defining illness" />AIDS Defining illness</td>
<td><input type="radio" name="assessment" value="Opportunistic Infections" />Opportunistic Infections</td>
</tr>
</table>
<br />
</div>
