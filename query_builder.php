...
<br />
<br />
<form class="myform" id="qbuild" name="qbuild" method="GET" action="query_builder.php">
<textarea rows="10px" style="width:600px; resize:none" required="Enter SQL Statement" name="buildq" id="buildq">
<?php if(isset($_GET["buildq"]) && strpos($_GET["buildq"], "INTO OUTFILE") === FALSE ){ echo $_GET["buildq"]." INTO OUTFILE 'C:/CIS_PRO_FILES/CiSQuery/CISQuery3.csv' FIELDS TERMINATED BY ',' ENCLOSED BY '\"' LINES TERMINATED BY '\n'";} else{if(isset($_GET["buildq"])) echo $_GET["buildq"]; } ?>
</textarea>
<button type="submit" style="alignment-adjust:middle">EXECUTE</button>
...
{
$fields=mysqli_num_fields($result) or die("Query Exported to EXCEL version CSV");
}
echo "<table>\n<tr>";
