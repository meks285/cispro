...
while($row = mysqli_fetch_array($result))
  {
if(empty($row['visitdate'])||empty($row['artduration'])||empty($row['tbstatus'])||empty($row['whostage'])||empty($row['eddpmtct'])||empty($row['regimen'])||empty($row['cotrimdose'])||empty($row['inhdose'])||empty($row['cd4scheduled'])||empty($row['vlscheduled'])){

  echo "<tr>";
  echo '<td><a href="carecard2browseval.php?visitdate=' . $row['visitdate'] . '&amp;pepid=' . $row['pepid'] . '&amp;username=' . $_GET['username'] . '" style="color:red; padding: 3px;">Critical Fields Missing</a></td>';
  echo '<td><a href="carecard2browse.php?visitdate=' . $row['visitdate'] . '&amp;pepid=' . $row['pepid'] . '&amp;username=' . $_GET['username'] . '" style="color:blue; padding: 3px;"">Browse</a></td>';
  ...
  echo "<tr>";
  echo '<td style="color:green; padding: 3px;">Validated - OK</a></td>';
  echo '<td><a href="carecard2browse.php?visitdate=' . $row['visitdate'] . '&amp;pepid=' . $row['pepid'] . ' style="color:blue; padding: 3px;"">Browse</a></td>';
  echo "<td>" . $row['pepid'] . "</td>";
  echo "<td>" . $row['visitschd'] . "</td>";
  echo "<td>" . $row['visitdate'] . "</td>";
  echo "<td>" . $row['artduration'] . "</td>";
