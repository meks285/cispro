...
<input tabindex="disable" type="text" name="careentrypointo" id="careentrypointo" value="<?php if ($info['careentrypoint']=='OPD' || $info['careentrypoint']=='In Patient' || $info['careentrypoint']=='TB DOTS' || $info['careentrypoint']=='STI Clinic' || $info['careentrypoint']=='ANC/PMTCT' || $info['careentrypoint']=='Transfer In' || $info['careentrypoint']=='Outreaches' || $info['careentrypoint']=='HCT') {echo $info['careentrypoint'];} else {echo $info['careentrypoint'];} ?>" placeholder="Others (Specify)" onChange="update11();" style="color:#F00; font-style:italic; width:120px; height:30px" />
        </fieldset>
         </div>
...
<input type="date" name="patienttransindate" id="patienttransindate" value="<?php if($info1a['facilityprefix']!=$info1a['patientprefix']){ if(isset($info['patienttransindate'])){echo $info['patienttransindate'];} else { echo $info['enroldate']; } } else {}?>" style="width:120px;height:10px;"/>
      </fieldset>
         </div>
        <div style="width: 300px; display: table-cell;"> 
        <fieldset style="height:20px; border:none">
