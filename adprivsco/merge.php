<?php
 ////////////////////CREATE backup FOLDER/////////////
	if (!file_exists('C:\CIS_PRO_FILES\MERGE_CIS')) {
    mkdir('C:\CIS_PRO_FILES\MERGE_CIS', 0777, true);
	}
...
<h1 style="background-color:#0F0;font-weight: 600;    font-family: 'Titillium Web', sans-serif;  position: relative;   font-size: 32px; line-height: 15px; padding: 15px 15px 15px 15%;    color: #355681;    box-shadow:         inset 0 0 0 1px rgba(53,86,129, 0.4),         inset 0 0 5px rgba(53,86,129, 0.5),        inset -285px 0 35px white;    border-radius: 0 10px 0 10px;    background: #fff url(../images/bartoszkosowski.jpg) no-repeat center left;">Merge Multiple Databases</h1>
<body>
<a style="font-weight:bold; font-size:14px; color:blue" href="./">[BACK]</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="./mergeindv.php">[Merge | Table Level]</a>
<div id="stylized1" class="myform">
</div>
<br>
<div id="stylized" class="myform">
<p style="color:red">WARNING: Make sure the folder "C:\CIS_PRO_FILES\MERGE_CIS" exists and is empty!</p>
<a href="?merge=true" style="font-weight:bold; color:#063; font-family:'Comic Sans MS', cursive">EXPORT For Merge</a>
<?php
error_reporting(0);
if ($_GET['merge']) {
  # This code will run if ?run=true is set.
  shell_exec("C:\wamp\www\apindb\adprivsco\CiSPromerge.bat");
  echo "<br />";
  echo "Export Complete, Check \"C:\CIS_PRO_FILES\MERGE_CIS\" ";
}
?>
...
<br />
<div id="stylized" class="myform">
<p>Merge: Make sure all Merge Export files are in the folder "C:\CIS_PRO_FILES\MERGE_CIS"</p>
<a href="?mergerest=true" style="font-weight:bold; color:#063; font-family:Verdana, Geneva, sans-serif">IMPORT Merged Database</a>
<?php
error_reporting(0);
if ($_GET['mergerest']) {
  # This code will run if ?res=true is set.
  shell_exec("C:\wamp\www\apindb\adprivsco\CiSPromergerest.bat");
  echo "<br />";
