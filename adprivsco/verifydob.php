...
class MyClass{
    public function GetUserInformation(){
		$pepid=$_GET['pepid'];
$query = "SELECT idpatient, pepid,surname,othernames,dob
...
<form id="formId" method="post" action="verifydobin.php" >
...
<input type="text" name="idpatient" id="idpatient" required="required" readonly value="<?php echo $info['idpatient']?>" style="width:30px; height:10px; font-weight:bold" />
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">Set D.o.B</span>
</label>
<input type="date" name="dob" id="dob" required value="<?php echo $info['dob']?>" style="width:120px; height:10px; font-weight:bold" />
...
<button type="submit" id="submit">UPDATE D.o.B</button>
