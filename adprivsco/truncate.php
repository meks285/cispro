...
<p>TRUNCATE: Please make a backup of the CIS Pro before starting this process</p>
<a href="?run=true" onclick="return confirm('This deletes all data on CIS PRO!!! Are you sure?');">Truncate!</a>
<?php
error_reporting(0);
if ($_GET['run']) {
  # This code will run if ?run=true is set.
  shell_exec("C:\wamp\www\apindb\adprivsco\CiSProTrunc.bat");
  echo "<br />";
  echo "Complete!";
}
?>
