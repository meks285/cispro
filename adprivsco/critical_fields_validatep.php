...
<tr>
	...
	<td><label for="pepid" style="font-weight: bold"><input type="text" name="pepid" id="pepid" value="<?php echo $followingdata['pepid']?>" style="width:80px;"/></label></td>
...
<tr>
	<td><label id="pcurrmedsl">29. Current Medications</label>
<div class="radio-toolbar">
<table>
<tr>
<td><input type="radio" name="pcurrmeds" value="None" <?php if ($followingdata['pcurrmeds']=='None') { echo 'checked'; } ?>/>None</td>
<td><input type="radio" name="pcurrmeds" value="ART" <?php if ($followingdata['pcurrmeds']=='ART') { echo 'checked'; } ?>/>ART</td>
</tr>
<tr>
<td><input type="radio" name="pcurrmeds" value="CTX" <?php if ($followingdata['pcurrmeds']=='CTX') { echo 'checked'; } ?>/>CTX</td>
<td><input type="radio" name="pcurrmeds" value="Anti-TB" <?php if ($followingdata['pcurrmeds']=='Anti-TB') { echo 'checked'; } ?>/>Anti-TB</td>
</tr>
<tr>
<td><input type="radio" name="pcurrmeds" value="Others" <?php if ($followingdata['pcurrmeds']=='Others') { echo 'checked'; } ?>/>Others</td>
</tr>
</table>
</div></td>
<td><label id="ppreviousarvpmtctl">28. Previous ART exposure through PMTCT</label>
<div class="radio-toolbar">
<table>
<tr>
<td><input type="radio" name="ppreviousarvpmtct" value="Yes" <?php if ($followingdata['ppreviousarvpmtct']=='Yes') { echo 'checked'; } ?> />Yes</td>
<td><input type="radio" name="ppreviousarvpmtct" value="No" <?php if ($followingdata['ppreviousarvpmtct']=='No') { echo 'checked'; } ?> />No</td>
</tr>
</table>
</div>   </td>
</tr>
...
function checkFilled() {
    ...
    var currentmedicationsl = document.getElementById("pcurrmedsl");
    ...
    var ppreviousarvpmtctl = document.getElementById("ppreviousarvpmtctl");
	var whostagecriteria = "<?php echo $followingdata['whostagecriteria']; ?>"; 
	var currentmedications = "<?php echo $followingdata['pcurrmeds']; ?>"; 
	var symptomsreview = "<?php echo $followingdata['symptomsreview']; ?>"; 
	var ppreviousarvpmtct = "<?php echo $followingdata['ppreviousarvpmtct']; ?>"; 
...
//	
	if (ppreviousarvpmtct.value == "" || ppreviousarvpmtct.value == "0"|| ppreviousarvpmtct.value == null) {
        ppreviousarvpmtctl.style.backgroundColor = "red";
    }
    else{
		 ppreviousarvpmtctl.style.backgroundColor = "";      
	}
//	
