...
//$newpepid='AB-13-0001';
$result = mysqli_query($con,"select pepid,surname,othernames from patient where dob='' or dob is null or dob='0000-00-00' or dob like '0%'");
