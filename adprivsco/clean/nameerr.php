...
//$newpepid='AB-13-0001';
$result = mysqli_query($con,"select pepid,surname,othernames from patient where surname='' or othernames='' or surname is null or othernames is null");
