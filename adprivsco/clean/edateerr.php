...
//$newpepid='AB-13-0001';
$result = mysqli_query($con,"select pepid,surname,othernames from patient where enroldate='' or enroldate is null or enroldate='0000-00-00' or enroldate like '0%'");
