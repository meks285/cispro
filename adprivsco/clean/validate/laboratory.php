...
//$newpepid='AB-13-0001';
$result = mysqli_query($con,"select * from laboratory where visitdate='' or visitdate is null or visitdate='0000-00-00' or visitdate like '0%'");
