...
<form id="formId" method="post" action="namobin.php" >
...
<input type="hidden" name="dob" id="dob" required value="<?php echo $info['dob']?>" style="width:120px; height:10px; font-weight:bold" />
...
<button type="submit" id="submit">UPDATE Name</button>
