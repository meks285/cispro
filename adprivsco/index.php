...
<tr>
<td>
<a href="./newuser.php" style="font-weight:bold; font-size:14px; color:green">New CIS Pro User</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./backup.php" style="font-weight:bold; font-size:14px">Restore Database</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./truncate.php" style="font-weight:bold; font-size:14px; color:red">Truncate CIS Pro</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./pepmngmt.php" style="font-weight:bold; font-size:14px; color:red">Patient ID (Management)</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./merge.php" style="font-weight:bold; font-size:14px; color:green">Merge</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./audit_management.php" style="font-weight:bold; font-size:14px; color:red">Audit Management</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</tr>
<tr>
<td>
<a href="../ndr_while_catch.php" style="font-weight:bold; font-size:14px; color:red">Generate INITIAL-NDR</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="../ndr_while_catch_update.php" style="font-weight:bold; font-size:14px; color:red">Generate UPDATED-NDR</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</tr>
</table>
</fieldset>
...
$result = mysqli_query($con,"SELECT USERNAME, PASSWORD,CREATIONDATE, ROLE from members");
...
while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo '<td><a href="user.php?USERNAME=' . $row['USERNAME'] . '&amp;CREATIONDATE=' . $row['CREATIONDATE'] . '" onclick="return confirm(\'This is irreversible!!! Are you sure?\');">Del</a></td>';
