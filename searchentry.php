...
<h1 style="background-color:#0F0;font-weight: 600;    font-family: 'Titillium Web', sans-serif;  position: relative;   font-size: 32px; line-height: 15px; padding: 15px 15px 15px 15%;    color: #355681;    box-shadow:         inset 0 0 0 1px rgba(53,86,129, 0.4),         inset 0 0 5px rgba(53,86,129, 0.5),        inset -285px 0 35px white;    border-radius: 0 10px 0 10px;    background: #fff url(./images/bartoszkosowski.jpg) no-repeat center left;">FIND PATIENTS REGISTERED IN A PARTICULAR MONTH</h1>
<a href="./registration.php?username=<?php if(isset($_GET["username"])) echo $_GET["username"]; ?>" style="font-weight:bold; font-size:14px">[BACK]</a>

<div id="stylized" class="myform">
<form id="form" name="form" method="GET" action="todayslists.php">
<h2>SELECT ANY DATE WITHIN THE DESIRED MONTH AND YEAR and Click the BUTTON</h2>
<fieldset>
<legend style="font-weight:bold; font-size:11px">Select Data Entry Date</legend>
<div class="style_form">
<label for="entrydate">
</label>
<input type="date" name="created_on" id="created_on" maxlength="10" required class="form_element" autocomplete="off" style="width:170px; height:30px; font-weight:bold; font-size:16px"/>
