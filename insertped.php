...
$pmotheradd=$_POST['pmotheradd'];include './mandate_/lidh.php';
$pmotheradd=mysqli_real_escape_string($con,$pmotheradd);
}else {
$pmotheradd="";
}
...
$pfatheradd=$_POST['pfatheradd'];include './mandate_/lidh.php';
$pfatheradd=mysqli_real_escape_string($con,$pfatheradd);
}else {
$pfatheradd="";
}
...
$address=$_POST['address'];include './mandate_/lidh.php';
...
'];include './mandate_/lidh.php';
$address=mysqli_real_escape_string($con,$pcaregiversrelationshipstatus
);
}else {
$pcaregiversrelationshipstatus
="";
...
$addrwardvillage=$_POST['addrwardvillage'];include './mandate_/lidh.php';
...
$addrlga=$_POST['addrlga'];include './mandate_/lidh.php';
...
$query = "INSERT INTO patient (pepid, uniqueid,hospitalid,surname, othernames,sex,lga,facilityname,dob,pmotheralive,pmothername,pmotheradd,pfatheralive,pfathername,pfatheradd,pcaregiversrelationshipstatus,psiblings,pchildliveswith,hivposdate,enroldate,jobstatusfather,jobstatusmother,jobstatuscaregiver,educationallevelchild,educationallevelmother,educationallevelfather,educationallevelcaregiver,address,wardvillage,town,addrlga,state,phoneno,agemonth)
VALUES
('$pepid','$_POST[uniqueid]','$hospitalid','$_POST[surname]','$_POST[othernames]','$_POST[sex]',
...
echo mysqli_error($con);
    ...
    if (mysqli_num_rows($resultmigration)==1){
		...
		header("refresh:3;./pedinitialeval.php?username=".$_POST['username']."&pepid=".$_POST['pepid']);
	}
session_write_close();
$pepid = $_POST['pepid'];
$pepid = strtoupper($pepid);
