...
function checkcd4()  
{  
if ((document.form.lastcd4.value<500)&& (document.form.lastcd4.value!=0)) 
document.getElementById('a5b').innerHTML ='CD4 < 500. Consider starting on ART';
else  
...
function DurValidate()
{
var ONE_DAY = 1000 * 60 * 60 * 24
var prevdurationofcarefromdate = new Date();
var prevdurationofcarefromdate = new Date(document.getElementById('prevdurationofcarefromdate').value);
//var prevdurationofcarefromdate = prevdurationofcarefromdate.getFullYear();

var td1 = new Date(document.getElementById('prevdurationofcaretodate').value);
//var td1 = td1.getFullYear();

var intAge = td1.getTime() - prevdurationofcarefromdate.getTime();
var intAge = Math.round(intAge/ONE_DAY);
document.getElementById('durcalc').value = intAge;
}
...
<br />
<br />
<body onload="if(document.referrer=='') self.location='./index.php';anccheck();arvexpcheck();adherencecheck();missedadhcheck();interradhcheck();stopadhcheck();allergychk();bmicalc();checkcd4()">
...
<input type="text" name="lga" id="lga" value="<?php echo $info1a['lga']?>" style="width:120px;height:10px;"/>
...
<input type="text" name="lga" id="lga" value="<?php echo $info1a['state']?>" style="width:120px;height:10px;"/>
...
<input type="text" name="othernames" id="othernames" required="required" placeholder="Required" value="<?php echo $info['othernames']?>" style="width:120px; height:10px;"/>
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">7. Hospital (unit) No</span>
</label>
...
<input type="date" name="dob" id="dob" required="required" value="<?php echo $info['dob']?>" placeholder="Required" onChange="validateAge()" style="width:118px;height:10px;"/> 
        ...
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">11b. Age(yrs)</span>
</label>
...
<legend style="font-weight:bold; font-size:11px">12. Presenting Complaint</legend>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">13. Symptoms Review</legend>
...
<tr>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Fever/Chills" <?php if (strpos($info['symptomsreview'],'Fever/Chills') !== false||strpos($info['symptomsreview'],'Fever') !== false) { echo 'checked'; }?> >Fever/Chills</td>
...
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Shortness of Breath" <?php if (strpos($info['symptomsreview'],'Shortness of Breath') !== false||strpos($info['symptomsreview'],'Fatigue') !== false) { echo 'checked'; }?> >Shortness of Breath</td>
...
<tr> 
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Nausea/Vomitting" <?php if (strpos($info['symptomsreview'],'Nausea/Vomitting') !== false||strpos($info['symptomsreview'],'Nausea') !== false||strpos($info['symptomsreview'],'Vomitting') !== false) { echo 'checked'; }?> >Nausea/ Vomitting</td>
<td><input type="text" name="dur_nausea" id="dur_nausea" style="width:20%;height:10px;" value="<?php echo $info['dur_nausea']?>"/></td>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Itching" <?php if (strpos($info['symptomsreview'],'Itching') !== false||strpos($info['symptomsreview'],'Itchy') !== false) { echo 'checked'; }?> >Itching</td>
...
<tr>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Night Sweats" <?php if (strpos($info['symptomsreview'],'Night Sweats') !== false||strpos($info['symptomsreview'],'sweats') !== false||strpos($info['symptomsreview'],'Sweats') !== false) { echo 'checked'; }?> >Night Sweats </td>
<td><input type="text" name="dur_nsweats" id="dur_nsweats" style="width:20%;height:10px;" value="<?php echo $info['dur_nsweats']?>"/></td>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Chronic Diarrhea" <?php if (strpos($info['symptomsreview'],'Chronic Diarrhea') !== false||strpos($info['symptomsreview'],'Diarrhea, chronic') !== false) { echo 'checked'; }?> >Chronic Diarrhea</td>
<td><input type="text" name="dur_diarh" id="dur_diarh" style="width:20%;height:10px;" value="<?php echo $info['dur_diarh']?>"/></td>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Pain/Difficulty when swallowing" <?php if (strpos($info['symptomsreview'],'Pain/Difficulty when swallowing') !== false||strpos($info['symptomsreview'],'Sore throat') !== false) { echo 'checked'; }?> >Pain when swallowing</td>
<td><input type="text" name="dur_painswall" id="dur_painswall" style="width:20%;height:10px;" value="<?php echo $info['dur_painswall']?>"/></td>
</tr>
<tr> 
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Recent Weight Loss" <?php if (strpos($info['symptomsreview'],'Recent Weight Loss') !== false||strpos($info['symptomsreview'],'>10%') !== false) { echo 'checked'; }?> >Recent Weight Loss</td>
<td><input type="text" name="dur_weigthl" id="dur_weigthl" style="width:20%;height:10px;" value="<?php echo $info['dur_weigthl']?>"/></td>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Genital Discharge" <?php if (strpos($info['symptomsreview'],'Genital Discharge') !== false||strpos($info['symptomsreview'],'Discharge (pen') !== false) { echo 'checked'; }?> >Genital Discharge </td>
<td><input type="text" name="dur_gendis" id="dur_gendis" style="width:20%;height:10px;" value="<?php echo $info['dur_gendis']?>"/></td>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Numbness/Tingling" <?php if (strpos($info['symptomsreview'],'Numbness/Tingling') !== false||strpos($info['symptomsreview'],'Pain/tingling/numbness') !== false) { echo 'checked'; }?> >Numbness/ Tingling </td>
...
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Pain (other site)" <?php if (strpos($info['symptomsreview'],'Pain (other site)') !== false||strpos($info['symptomsreview'],'Aches') !== false||strpos($info['symptomsreview'],'Body pain') !== false||strpos($info['symptomsreview'],'Joint pain') !== false||strpos($info['symptomsreview'],'Back pain') !== false||strpos($info['symptomsreview'],'Chest pain') !== false||strpos($info['symptomsreview'],'Abdominal pain') !== false||strpos($info['symptomsreview'],'Body/burning') !== false) { echo 'checked'; }?> >Pain (other site) </td>
<td><input type="text" name="dur_otherpain" id="dur_otherpain" style="width:20%;height:10px;" value="<?php echo $info['dur_otherpain']?>"/></td>
</tr>
<tr>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Headache" <?php if (strpos($info['symptomsreview'],'Headache') !== false||strpos($info['symptomsreview'],'Aches') !== false) { echo 'checked'; }?> >Headache </td>
<td><input type="text" name="dur_head" id="dur_head" style="width:20%;height:10px;" value="<?php echo $info['dur_head']?>"/></td>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Genital Sores" <?php if (strpos($info['symptomsreview'],'Genital Sores') !== false||strpos($info['symptomsreview'],'Ulcer (penile') !== false) { echo 'checked'; }?> >Genital Sores </td>
<td><input type="text" name="dur_gensore" id="dur_gensore" style="width:20%;height:10px;" value="<?php echo $info['dur_gensore']?>"/></td>
</tr>
</table>
<fieldset>
<label>
<span class="small" style="font-weight:bold">14. Patient Accessed for TB</span>
<table>
<tr>
...
<label>
<span class="small" style="font-weight:bold">15. Additional Comments</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">16. Past Medical History</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">17. Relevant Family History</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">18. Hospitilization</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">19. Drug Allergies?</span>
<table>
<tr>
<td><input type="radio" name="knwnallergy" id="allyes" onchange="allergychk()" <?php if (!empty($info['drugallergies'])) { echo 'checked'; } ?> />Yes</td>
<td><input type="radio" name="knwnallergy" id="allno" onchange="allergychk()"/>No</td>
</tr>
</table>
</label>
...
<label>
<span class="small" style="font-weight:bold">20a Currently Pregnant</span>
</label>
<table>
<tr>
<td><input type="radio" name="currentlypregnant" id="yespreg" value="Yes" <?php if ($info['currentlypregnant']=='Yes') { echo 'checked'; } ?> required="required" onchange="anccheck()" />Yes</td>
<td><input type="radio" name="currentlypregnant" id="nopreg" value="No" <?php if ($info['currentlypregnant']=='No') { echo 'checked'; } ?> required="required" onchange="anccheck()"/>No</td>
<td><input type="radio" name="currentlypregnant" id="uncpreg" value="Uncertain" <?php if ($info['currentlypregnant']=='Uncertain') { echo 'checked'; } ?> required="required" onchange="anccheck()"/>Uncertain</td>
</tr>
</table>
...
<label>
<span class="small" style="font-weight:bold">20b. Last Menstrual Period</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">20c. Gestational Age(wks)</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">20d. Expected Date of Delivery</span>
</label>
...
<label>
<span class="small" style="font-weight:bold">20e. Currently Breast Feeding</span>
</label>
<table>
<tr>
<td><input type="radio" name="currentlybreastf" value="Yes" <?php if ($info['currentlybreastf']=='Yes') { echo 'checked'; } ?>/>Yes</td>
<td><input type="radio" name="currentlybreastf" value="No" <?php if ($info['currentlybreastf']=='No') { echo 'checked'; } ?>/>No</td>
<td><input type="radio" name="currentlybreastf" value="Uncertain" <?php if ($info['currentlybreastf']=='Uncertain') { echo 'checked'; } ?>/>Uncertain</td>
</tr>
</table>
...
<label>
<span class="small" style="font-weight:bold">21. Previous ARV Exposure</span>
</label>
<table>
<tr>
...
<table>
<tr>
<td><input type="radio" name="prevarvtype" id="prevarvtype" value="Transfer in with records" <?php if ($info['prevarvtype']=='Earlier ARV But not a Transfer In') { echo 'checked'; } ?>>Earlier ARV But not a Transfer In</td>
<td><input type="radio" name="prevarvtype" id="prevarvtype" value="Earlier ARV not transfer in" <?php if ($info['prevarvtype']=='PMTCT Only') { echo 'checked'; } ?>>PMTCT Only</td>
<td><input type="radio" name="prevarvtype" id="prevarvtype" value="Never recieved ARVs" <?php if ($info['prevarvtype']=='Never recieved ARVs') { echo 'checked'; } ?>>Never recieved ARVs</td></tr>
</table>
</div>
...
<input type="text" name="prevfacilityname" id="prevfacilityname" style="width:180px; height:10px;" value="<?php echo $info['prevfacilityname']?>"/>
...
<label>
<span class="small" style="font-weight:bold">21b. Duration of Care(From):</span>
</label>
<input type="date" name="prevdurationofcarefromdate" id="prevdurationofcarefromdate" onChange="DurValidate()" value="<?php echo $info['prevdurationofcarefromdate']?>" style="width:120px;height:10px;"/>
...
<label>
<span class="small" style="font-weight:bold">(To):</span>
</label>
<input type="date" name="prevdurationofcaretodate" id="prevdurationofcaretodate" onChange="DurValidate()" value="<?php echo $info['prevdurationofcaretodate']?>"  style="width:118px;height:10px;"/> 

        </fieldset>
         </div>        <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
<label>
<span class="small" style="font-weight:bold">DURATION (Days)</span>
</label>
<input type="text" name="durcalc" id="durcalc" value="" style="width:35px;height:10px;"/>
...
<label>
<span class="small" style="font-weight:bold">22. Current Medications</span>
</label>
<div class="checkbox-toolbar">
<table>
<tr>
<td><input type="checkbox" name="currentmedications[]" id="currentmedications" value="None*" <?php if (strpos($info['currentmedications'],'None*') !== false||$info['currentmedications']==':Currently ineligible:None:') { echo 'checked'; }?>>None</td>
...
<td><input type="checkbox" name="currentmedications[]" id="currentmedications" value="CTX" <?php if (strpos($info['currentmedications'],'CTX') !== false||strpos($info['currentmedications'],'COTRIMOXAZOLE') !== false||strpos($info['currentmedications'],'Cotrimoxazole') !== false) { echo 'checked'; }?>>CTX</td>
<td><input type="checkbox" name="currentmedications[]" id="currentmedications" value="Anti-TB" <?php if (strpos($info['currentmedications'],'Anti-TB') !== false||strpos($info['currentmedications'],'INH') !== false||strpos($info['currentmedications'],'STR') !== false||strpos($info['currentmedications'],'ETH') !== false||strpos($info['currentmedications'],'RIF') !== false||strpos($info['currentmedications'],'B6') !== false||strpos($info['currentmedications'],'PZA') !== false) { echo 'checked'; }?>>Anti-TB Drugs</td>
<td><input type="checkbox" name="currentmedications[]" id="currentmedications" value="STI" <?php if (empty($info['currentmedications'])&&(strpos($info['currentmedications'],'Others') !== false||strpos($info['currentmedications'],'INH') == false||strpos($info['currentmedications'],'STR') == false||strpos($info['currentmedications'],'ETH') == false||strpos($info['currentmedications'],'RIF') == false||strpos($info['currentmedications'],'B6') == false||strpos($info['currentmedications'],'PZA') == false||strpos($info['currentmedications'],'COTRIMOXAZOLE') == false||strpos($info['currentmedications'],'Cotrimoxazole') == false||strpos($info['currentmedications'],'ART') == false||strpos($info['currentmedications'],'None*') == false||$info['currentmedications']!==':Currently ineligible:None:'||strpos($info['currentmedications'],':') == false)) { echo 'checked'; }?>>Others</td>
</tr>
</table>
</div>
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        ...
        <fieldset style="border:none">
		<label>
<span class="small" style="font-weight:bold">Others (Specify)</span>
</label>

<input type="text" name="otherspec" id="otherspec" style="width:90px; height:10px;" placeholder="Others" value="<?php echo $info['otherspec']?>"/>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="border:none">
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
		...
		<label>
<span class="small" style="font-weight:bold">23. Patient has disclosed status to: </span>
</label>
...
<input type="text" name="hivstatdisclosureother" id="hivstatdisclosureother" style="width:50px; height:10px;" value="<?php echo $info['hivstatdisclosureother']?>" />        </fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="border:none">
...
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        ...
        <fieldset style="border:none">
		<label>
<span class="small" style="font-weight:bold">24. HIV Status an be discussed with:</span>
</label>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">25. Past or current ARV side effects</legend>
<div class="checkbox-toolbar">
<table>
<label></label>
<tr>
<td><input type="checkbox" name="pastcurrarvsideeff[]" id="pastcurrarvsideeff" value="None" <?php if (strpos($info['pastcurrarvsideeff'],'None') !== false) { echo 'checked'; }?>>None</td>
</tr>
<tr>
...
<td><input type="checkbox" name="pastcurrarvsideeff[]" id="pastcurrarvsideeff" value="Other" <?php if (strpos($info['pastcurrarvsideeff'],'Other') !== false) { echo 'checked'; }?>>Other</td>
</tr>
</table>
</div>
<fieldset style="width:650px; height:30px; border:none">
<div style="width: 100%; display: table;">
    <div style="display: table-row">
...
<input type="text" name="pastcurrarvsideeff[]" id="pastcurrarvsideeff" style="width:100px; height:10px;" value="<?php echo $info['pastcurrarvsideeff']?>" />        </fieldset>
         </div>
        <div style="display: table-cell;"> 
        <fieldset style="border:none">
...
<input type="text" name="pebp" id="pebp" style="width:40px; height:10px;" value="<?php echo $info['pebp']?>" />
      </fieldset>
        </fieldset>
         </div>       
        <div style="display: table-cell;"> 
...
<tr>
<td><input type="text" name="pegenappearance[]" id="pegenappearance" value="<?php $info['pegenappearance'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<tr>
<td><input type="text" name="gerespiratory[]" id="gerespiratory" value="<?php $info['gerespiratory'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<tr>
<td><input type="text" name="peskin[]" id="peskin" value="<?php $info['peskin'];?>" placeholder="Others" ></td>
</tr>
...
<tr>
<td><input type="text" name="gegastrointestinal[]" id="gegastrointestinal" value="<?php $info['gegastrointestinal'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<tr>
<td><input type="text" name="peheadeye[]" id="peheadeye" value="<?php $info['peheadeye'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<tr>
<td><input type="text" name="pecardiovascular[]" id="pecardiovascular" value="<?php $info['pecardiovascular'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<tr>
<td><input type="text" name="geneurological[]" id="geneurological" value="<?php $info['geneurological'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<tr>
<td><input type="text" name="pebreasts[]" id="pebreasts" value="<?php $info['pebreasts'];?>" placeholder="Others" ></td>
</tr>
...
<tr>
<td><input type="text" name="pegenitalia[]" id="pegenitalia" value="<?php $info['pegenitalia'];?>" placeholder="Others" ></td>
</tr>

</table>
</div>
</fieldset>
<fieldset style="height:335px">
...
<tr>
<td><input type="text" name="gementalstatus[]" id="gementalstatus" value="<?php $info['gementalstatus'];?>" placeholder="Others" ></td>
</tr>
</table>
</div>
</fieldset>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">27. Assessment</legend>
<div class="radio-toolbar"> 
<table>
<label></label>
<tr>
<td><input type="radio" name="assessment" value="Asymptomatic" <?php if ($info['assessment']=='Asymptomatic'||$info['assessment']=='A') { echo 'checked'; } ?>
/>Asymptomatic</td>
<td><input type="radio" name="assessment" value="Symptomatic" <?php if ($info['assessment']=='Symptomatic'||$info['assessment']=='B') { echo 'checked'; } ?>/>Symptomatic</td>
<td><input type="radio" name="assessment" value="AIDS defining illness" <?php if ($info['assessment']=='AIDS defining illness'||$info['assessment']=='C') { echo 'checked'; } ?>/>Aids Defining illness</td>
<td><input type="radio" name="assessment" value="Opportunistic Infections" <?php if ($info['assessment']=='Opportunistic Infections'||$info['assessment']=='D') { echo 'checked'; } ?>/>Opportunistic Infections</td>
</tr>
</table>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">28a. WHO Staging criteria(History of any of the following)</legend>

<div style="width: 100%; display: table;">
    <div style="display: table-row">
        <div style="width: 400px; display: table-cell;"> 
		<fieldset style="height:42px">
<legend style="font-weight:bold; font-size:11px">28b. WHO Stage</legend>
<select name="clinicalstageart" id="clinicalstageart" style="height:20px; width:60px">
	<option value="<?php echo $info['whostage']; ?>"><?php echo $info['whostage']; ?></option> 
...
<tr>
<td><input type="checkbox" name="whostagecriteria[]" value="Salmonella Septicemia, Non-Typhoid"  <?php if (strpos($info['whostagecriteria'],'almonella Septicemia, Non-Typhoid') !== false) { echo 'checked'; }?>/>almonella Septicemia, Non-Typhoid</td>
</tr>
<tr>
<td><input type="checkbox" name="whostagecriteria[]" value="TB, Extrapulmonary"  <?php if (strpos($info['whostagecriteria'],'TB, Extrapulmonary') !== false) { echo 'checked'; }?>/>TB, Extrapulmonary</td>
</tr>
<tr>
<td><input type="checkbox" name="whostagecriteria[]" value="Lymphoma" <?php if (strpos($info['whostagecriteria'],'Lymphoma') !== false) { echo 'checked'; }?>/>Lymphoma</td>
</tr>
<tr>
<td><input type="checkbox" name="whostagecriteria[]" value="Kaposi Sarcoma"  <?php if (strpos($info['whostagecriteria'],'Kaposi Sarcoma') !== false) { echo 'checked'; }?>/>Kaposi Sarcoma</td>
</tr>
<tr>
<td><input type="checkbox" name="whostagecriteria[]" value="HIV Encephalopathy"  <?php if (strpos($info['whostagecriteria'],'HIV Encephalopathy') !== false) { echo 'checked'; }?>/>HIV Encephalopathy</td>
</tr>
<tr>
<td><input type="checkbox" name="whostagecriteria[]" value="Performance Scale: 4 bedridden >50% of the day in last Month"  <?php if (strpos($info['whostagecriteria'],'HIV Encephalopathy') !== false) { echo 'checked'; }?>/>Performance Scale: 4 bedridden >50% of the day in last Month</td>
</tr>
</table>
</div>
</fieldset>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">29. Plan (specify orders on requisition)</legend>
<div class="checkbox-toolbar"> 
<table>
<label></label>
<tr>
...
<tr>
<td><input type="checkbox" name="plan[]" id="plan" value="TB Investigation" <?php if (strpos($info['plan'],'TB Investigation') !== false) { echo 'checked'; }?>/>Investigate for Tuberculosis</td>
<td><input type="text" name="planpep" id="planpep"  style="height:10px; width:80px"  value="<?php echo $info['planpep']?>"/></td>
<td><input type="checkbox" name="plan[]" id="plan" value="Admission" <?php if (strpos($info['plan'],'Admission') !== false||strpos($info['plan'],'Hospitalization') !== false) { echo 'checked'; }?>>Admission</td>
...
<td><input type="checkbox" name="plan[]" id="plan" value="Symptomatic treatment/Pain control" <?php if (strpos($info['plan'],'Symptomatic treatment/Pain control') !== false||strpos($info['plan'],'Psychosocial counseling') !== false) { echo 'checked'; }?>>Symptomatic Treatment/Pain Control</td>
<td><input type="text" name="planpain" id="planpain"  style="height:10px; width:80px" value="<?php echo $info['planpain']?>"/></td>
</tr>
<tr>
<td><input type="checkbox" name="plan[]" id="plan" value="Adherence Counseling" <?php if (strpos($info['plan'],'Adherence Counseling') !== false||strpos($info['plan'],'Adherence counseling') !== false) { echo 'checked'; }?>/>Adherence Counseling</td>
<td><input type="text" name="planadh" id="planadh"  style="height:10px; width:80px" value="<?php echo $info['planadh']?>"/></td>
<td><input type="checkbox" name="plan[]" id="plan" value="Other" <?php if (strpos($info['plan'],'Other') !== false) { echo 'checked'; }?>>Other referrals (Specify)</td>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">30. Enroll in:</legend>
<div class="radio-toolbar"> 
<table>
<label></label>
<tr>
<td><input type="radio" name="enrollin" value="General Medical Follow up" <?php if ($info['enrollin']=='General Medical Follow up'||$info['enrollin']=='Continuing ART') { echo 'checked'; } ?>>General Medical Followup</td>
<td><input type="radio" name="enrollin" value="ARV Therapy" <?php if ($info['enrollin']=='ARV Therapy'||$info['enrollin']=='Starting ART'||$info['enrollin']=='Eligible but drugs unavailable') { echo 'checked'; } ?>>ARV Therapy</td>
<td><input type="radio" name="enrollin" value="Pending lab results" <?php if ($info['enrollin']=='Pending lab results'||$info['enrollin']=='Currently ineligible') { echo 'checked'; } ?>>Pending Lab results</td>
</tr>
</table>
</div>
</fieldset>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">31. Plan for ARV Therapy</legend>
<div class="radio-toolbar"> 
<table>
<label></label>
<tr>
...
<tr>
<td><input type="radio" name="planarvtherapy" value="Change treatment" <?php if ($info['planarvtherapy']=='Change treatment'||$info['planarvtherapy']=='Change in clinical plan:') { echo 'checked'; } ?>>Change treatment(Indicate reason code)</td>
...
<fieldset>
<legend style="font-weight:bold; font-size:11px">32a. Regimen</legend>
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        <div style="width: 200px; display: table-cell;"> 
        <fieldset style="border:none">
...
<label ></label>
<tr>
<td><input type="radio" name="regimen1st" value="AZT/3TC/EFV" <?php if ($info['regimen1st']=='AZT/3TC/EFV') { echo 'checked'; } ?>> 1a = AZT-3TC-EFV</td>
</tr>
<tr>
...
<tr>
<td><input type="radio" name="regimen1st" value="TDF/3TC/DTG" <?php if ($info['regimen1st']=='TDF/3TC/DTG') { echo 'checked'; } ?>
>1d = TDF-3TC-DTG</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="TDF/3TC/EFV400" <?php if ($info['regimen1st']=='TDF/3TC/EFV400') { echo 'checked'; } ?>
>1e = TDF-3TC-EFV400</td>
</tr>
</table>        
</div>
      </fieldset>
...
<label ></label>
<tr>
<td><input type="radio" name="regimen1st" value="TDF/3TC/ATVr" <?php if ($info['regimen1st']=='TDF/3TC/ATVr') { echo 'checked'; } ?>
>2a = TDF-3TC-ATVr</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="AZT/3TC/LPVr" <?php if ($info['regimen1st']=='AZT/3TC/LPVr') { echo 'checked'; } ?>
>2b = AZT-3TC-LPV/r</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="AZT/3TC/ATVr" <?php if ($info['regimen1st']=='AZT/3TC/ATVr') { echo 'checked'; } ?>
>2c = AZT-3TC-ATV/r</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="AZT/3TC/LPVr" <?php if ($info['regimen1st']=='AZT/3TC/LPVr') { echo 'checked'; } ?>
...
<tr>
<td><input type="radio" name="regimen1st" value="TDF/3TC/DRVr" <?php if ($info['regimen1st']=='TDF/3TC/DRVr') { echo 'checked'; } ?>
>2e = TDF-3TC-DRV/r</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="AZT/3TC/DRVr" <?php if ($info['regimen1st']=='AZT/3TC/DRVr') { echo 'checked'; } ?>
>2f = AZT-3TC-DRV/r</td>
</tr>
</table>        
</div>        
...
<legend style="font-weight:bold; font-size:11px">3rd Line/Salvage Regimen</legend>
<div class="radio-toolbar"> 
<table>
<label ></label>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="DRVr/DTG +_ 1-2 NRTIs" <?php if ($info['regimen1st']=='DRVr/DTG +_ 1-2 NRTIs') { echo 'checked'; } ?>
>3a = DRVr-DTG +_ 1-2 NRTIs</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="DRVr/2 NRTIs +_ NNRTI" <?php if ($info['regimen1st']=='DRVr/2 NRTIs +_ NNRTI') { echo 'checked'; } ?>
>3b = DRVr-2 NRTIs +_ NNRTI</td>
</tr>
<tr>
<td><input type="radio" name="regimen1st" value="DRVr/RAL +_ 1-2 NRTIs" <?php if ($info['regimen1st']=='DRVr/RAL +_ 1-2 NRTIs') { echo 'checked'; } ?>
>3c = DRVr-RAL +_ 1-2 NRTIs</td>
</tr>
<tr>
</table>        
</div>        
...
<legend style="font-weight:bold; font-size:11px">32. b. Drugs in Regimen</legend>
...
<fieldset >  
<legend style="font-weight:bold; font-size:11px">33. Next Appointment?</legend>
<div style="width: 100%; display: table;">
    <div style="display: table-row">
        <div style="width: 250px; display: table-cell;"> 
        <fieldset style="border:none">
...
<legend style="font-weight:bold; font-size:11px">FINDINGS:</legend>
<label id="a5b" style="color:#F00; font-style:italic; width:220px"></label>
</fieldset>
<fieldset>
...
<button type="submit" id="submit" style="alignment-adjust:middle">REGISTER</button>
...
$('#submit').click( function() {
        	...
        	var url = 'updateie.php';
        	$.post(url, 
        	query, 
        	function (response) {
        	alert ("I.C.E form Updated");
			});
