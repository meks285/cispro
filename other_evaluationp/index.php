...
if(mysqli_num_rows(mysqli_query($con,"SHOW TABLES LIKE '".$table."'"))==1){
		...
		$results = mysqli_query($con,"CREATE TABLE IF NOT EXISTS `art_adherence` (
  `id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `pepid` varchar(11) NOT NULL,
...
<a style="color:blue; font-weight:bold;" href="../patpedsummary.php?pepid=<?php echo $_SESSION['pepid'] ?>&login_id=<?php if(isset($_GET["username"])) echo $_GET["username"]; ?>" style="font-weight:bold; font-size:14px">[MAIN MENU]</a><br />
