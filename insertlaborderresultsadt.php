...
$query1="SELECT * from lab_results_pivot where pepid='$_POST[pepid]' and visitdate='$_POST[visitdatex]'";
			$result = mysqli_query($con,$query1);



if (mysqli_num_rows($result)>=1){
	$query9="delete from laboratory where pepid='$_POST[pepid]' and visitdate='$_POST[visitdatex]'";
...
$sql="INSERT into AUDIT_TRAIL (server_name,user_name,action) VALUES('$_SERVER[REMOTE_ADDR]','$_POST[username]','Update - Laboratory.: $_POST[pepid] - $_POST[visitdate]')";
