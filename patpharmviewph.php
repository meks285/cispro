...
elseif($role=='Lab'){
echo '<a href="dtentryportlab.php?username='.$_GET['userid'].'">[MAIN MENU]</a>&nbsp; &nbsp; &nbsp; &nbsp;'; 
	}
?>
<?php
if($role=='Pharm'){
echo '<a href="pharmacyordmainph.php?pepid=' . $_GET['pepid'] . '&userid=' . $_GET['userid'] . '">[NEW PHARM RECORD]</a>&nbsp; &nbsp; &nbsp; &nbsp;'; 
}
elseif($role=='Lab'){
echo '<a href="laborderresultadtla.php?pepid=' . $_GET['pepid'] . '&userid=' . $_GET['userid'] . '">[NEW LAB RECORD]</a>&nbsp; &nbsp; &nbsp; &nbsp;'; 
}
?>
<?php if(strlen($_GET['pepid'])==10&&$role=='Pharm'){ 
echo '<a href="patsearcha.php?username=' . $_GET['userid'] . '">[BACK]</a>';
} 
elseif(strlen($_GET['pepid'])==10&&$role=='Lab'){
echo '<a href="patsearcha.php?username=' . $_GET['userid'] . '">[BACK]</a>';
	}
elseif(strlen($_GET['pepid'])==11&&$role=='Lab'){
echo '<a href="patsearchpd.php?username=' . $_GET['userid'] . '">[BACK]</a>';
	}
elseif(strlen($_GET['pepid'])==11&&$role=='Pharm'){
echo '<a href="patsearchpd.php?username=' . $_GET['userid'] . '">[BACK]</a>';
	}
else{
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<tr>";
  echo '<td><a href="patpharmbrowseph.php?visitdate=' . $row['visitdate'] . '&amp;pepid=' . $row['pepid'] . '&amp;userid=' . $_GET['userid'] . '">Browse</a></td>';
...
while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo '<td><a href="labresultbrowseadtla.php?visitdate=' . $row['visitdate'] . '&amp;pepid=' . $row['pepid'] . '">Browse</a></td>';
  echo "<td>" . $row['visitdate'] . "</td>";
  echo "<td>" . $row['cd4'] . "</td>";
