...
$enroldate=$_GET['dolupload'];


$link = mysqli_connect('127.0.0.1', 'root', 'Nu66et%%','apindb');
if (!$link) {
...
$query_select = "SELECT a.idpatient as PatientIdentifier,a.pepid as pepid,(select facilityname from facility) as FacilityName,
(select facilityidprefix from facility) as facn,(select facilityname from sitelist where facilityid=SUBSTRING(a.pepid,1,2)) AS diagfac,(select datim_code from sitelist where facilityid=SUBSTRING(a.pepid,1,2)) AS diagcode,
uniqueid as IDNumber,dob as PatientDateOfBirth,substring(upper(sex),1,1) as PatientSexCode,CASE lower(patientdied) WHEN 'art' THEN 'true' WHEN 'pre-art' THEN 'true' ELSE 'false' END as PatientDeceasedIndicator,CASE educationallevel WHEN 'None' THEN 1 WHEN 'Quranic' THEN 4 WHEN 'Primary' THEN 2 WHEN 'Junior Secondary' THEN 5 WHEN 'Senior Secondary' THEN 3 WHEN 'Post Secondary' THEN 6 ELSE 7 END as PatientEducationLevelCode,CASE jobstatus WHEN 'Unemployed' THEN 'UNE' WHEN 'Student' THEN 'STU' WHEN 'Employed' THEN 'EMP' WHEN 'Retired' THEN 'RET' ELSE 'UNK' END as PatientOccupationCode,CASE maritalstatus WHEN 'Single' THEN 'S' WHEN 'Widowed' THEN 'W' WHEN 'Married' THEN 'M' WHEN 'Separated' THEN 'A' WHEN 'Divorced' THEN 'D' ELSE 'U' END as PatientMaritalStatusCode,CASE  
...
ELSE '' END as CodeRegEnc,b.regimen as CodeDescTxtRegEnc,CASE  WHEN dateartstart='0000-00-00' THEN (SELECT visitdate FROM `pharmacy` WHERE pepid=a.pepid and (drugname1 is not null OR drugname1!='') order by visitdate asc limit 1)
	  WHEN dateartstart IS NULL THEN (SELECT visitdate FROM `pharmacy` WHERE pepid=a.pepid and (drugname1 is not null OR drugname1!='') order by visitdate asc limit 1)ELSE dateartstart END AS ARTStartDate,clinicalstageart as WHOClinicalStageARTStart,ROUND(peweightatart) as WeightAtARTStart,CASE patfunction 
WHEN 'Working' THEN 'W' 
...
WHEN 'ETR' THEN '30' 
WHEN 'RTV' THEN '30' 
ELSE '' END as PrescribedRegimenLineCode,CASE d.regduration1 
WHEN '30' THEN 30
WHEN '60' THEN 60
WHEN '90' THEN 90
WHEN '0.2' THEN 6
...
WHEN '3O' THEN 30
WHEN '4' THEN 120
WHEN '4>4 MTHS' THEN 120
WHEN '6' THEN 180
ELSE 30 END
 as PrescribedRegimenDuration,CASE d.oiduration 
WHEN '1 month' THEN '30' 
WHEN '2 month' THEN '60' 
WHEN '3 month' THEN '90' 
WHEN '4 month' THEN '120' 
ELSE '30' END as PrescribedRegimenDurationCTXpharm,CASE d.tbduration 
WHEN '1 month' THEN '30' 
WHEN '2 month' THEN '60' 
WHEN '3 month' THEN '90' 
WHEN '4 month' THEN '120' 
ELSE '30' END as PrescribedRegimenDurationTBpharm,b.cd4value as cd4value,b.visitdate as CD4TestDate,CASE  
...
ON (a.pepid=d.pepid) 
where a.enroldate!='0000-00-00' and a.enroldate > '$enroldate' or (b.visitdate > '$enroldate' or c.visitdate > '$enroldate' or d.pharmdispensedate > '$enroldate') 
group by a.pepid order by a.pepid";
include './mandate_/lidh.php';

$result_select = mysqli_query($con,$query_select) or die(mysqli_error($con));
$rows = array();
...
foreach($rows as $row){
	...
	$DiagnosisFacility->addChild("FacilityID", $row['diagcode']);
...
group by visitdate order by visitdate ASC";
		...
		//============
		$result_enc = mysqli_query($con,$sql_enc) or die(mysqli_error($con));
		$rows_enc = array();
...
group by visitdate,tests order by visitdate ASC";
		...
		//$info1a=mysqli_fetch_assoc($resulta);
		//============
		$resultlab = mysqli_query($con,$sqllab) or die(mysqli_error($con));
		$rows_lab = array();
		while($row_lab = mysqli_fetch_array($resultlab))
		$rows_lab[] = $row_lab;
...
ELSE '' END as CodeDescTxtPharmDrgName1 ,pharmacyid as VisitIDpharm,visitdate as VisitDatepharm,CASE regduration1 
WHEN '30' THEN 30
WHEN '60' THEN 60
WHEN '90' THEN 90
WHEN '0.2' THEN 6
...
WHEN '4>4 MTHS' THEN 120
WHEN '6' THEN 180
ELSE 30 END as PrescribedRegimenDuration,drugname2,drugname3,drugname1,CASE 
WHEN oiqty like '%100%' AND oidrug like '%CTX%' THEN pharmacyid 
WHEN oiqty like '%120%' AND oidrug like '%CTX%' THEN pharmacyid 
...
WHEN oiqty like '%120%' AND oidrug like '%CTX%' THEN visitdate 
...
WHEN oiqty like '%120%' AND oidrug like '%CTX%' THEN 'CTX120' 
...
WHEN oiqty like '%120%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 100mg' 
...
WHEN '3 month' THEN '90' 
WHEN '4 month' THEN '120' 
ELSE '30' END as PrescribedRegimenDurationCTXpharm,CASE  
...
WHEN '3 month' THEN '90' 
WHEN '4 month' THEN '120' 
ELSE '30' END as PrescribedRegimenDurationTBpharm,CASE  
...
WHEN '3 month' THEN '90' 
WHEN '4 month' THEN '120' 
ELSE '30' END as PrescribedRegimenDurationCTXpharm
FROM pharmacy 
...
elseif($condition=='INITIAL'){$query_select = "SELECT a.idpatient as PatientIdentifier,a.pepid as pepid,(select facilityname from facility) as FacilityName,
(select facilityidprefix from facility) as facn,(select datim_code from sitelist where facilityid=SUBSTRING(a.pepid,1,2)) AS diagfac,
uniqueid as IDNumber,dob as PatientDateOfBirth,substring(upper(sex),1,1) as PatientSexCode,CASE lower(patientdied) WHEN 'art' THEN 'true' WHEN 'pre-art' THEN 'true' ELSE 'false' END as PatientDeceasedIndicator,CASE educationallevel WHEN 'None' THEN 1 WHEN 'Quranic' THEN 4 WHEN 'Primary' THEN 2 WHEN 'Junior Secondary' THEN 5 WHEN 'Senior Secondary' THEN 3 WHEN 'Post Secondary' THEN 6 ELSE 7 END as PatientEducationLevelCode,CASE jobstatus WHEN 'Unemployed' THEN 'UNE' WHEN 'Student' THEN 'STU' WHEN 'Employed' THEN 'EMP' WHEN 'Retired' THEN 'RET' ELSE 'UNK' END as PatientOccupationCode,CASE maritalstatus WHEN 'Single' THEN 'S' WHEN 'Widowed' THEN 'W' WHEN 'Married' THEN 'M' WHEN 'Separated' THEN 'A' WHEN 'Divorced' THEN 'D' ELSE 'U' END as PatientMaritalStatusCode,CASE  
WHEN whostagecriteria LIKE '%Asymptomatic%' THEN '236704009' 
WHEN whostagecriteria LIKE '%Persistent Lymphadenopathy%' THEN '95892003' 
WHEN whostagecriteria LIKE '%Minor Mucocutaneous Manifestations%' THEN '29147005' 
...
LEFT JOIN (select * from pharmacy order by visitdate DESC) d
ON (a.pepid=d.pepid) 
where a.enroldate!='0000-00-00'
AND a.enroldate > '$enroldate'
group by a.pepid order by a.pepid";
...
from clinicaleval
where pepid='$row[pepid]' and visitdate !='0000-00-00'
AND visitdate > '$enroldate' group by visitdate order by visitdate ASC LIMIT 1";
		//$resulta=mysqli_query($con,$sqla);
		//$info1a=mysqli_fetch_assoc($resulta);
		//============
		$result_enc = mysqli_query($con,$sql_enc) or die(mysqli_error($con));
...
WHEN 'WBC Diff' THEN '82'
ELSE '' END)!='' 
AND visitdate > '$enroldate' group by visitdate,tests order by visitdate ASC LIMIT 1";
		//$resulta=mysqli_query($con,$sqla);
		//$info1a=mysqli_fetch_assoc($resulta);
		//============
		$resultlab = mysqli_query($con,$sqllab) or die(mysqli_error($con));
...
ELSE '' END as CodeCTXPharm,CASE  
WHEN oiqty like '%100%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 100mg' 
WHEN oiqty like '%120%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 120mg' 
WHEN oiqty like '%200%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 200mg' 
WHEN oiqty like '%300%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 300mg' 
WHEN oiqty like '%480%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 480mg' 
WHEN oiqty like '%960%' AND oidrug like '%CTX%' THEN 'Cotrimoxazole 960mg' 
...
WHEN drugname1 like '%RTV%' THEN '30' 
ELSE '' END) !=''
AND visitdate > '$enroldate'
group by visitdate order by visitdate ASC LIMIT 1";
		//$resulta=mysqli_query($con,$sqla);
		//$info1a=mysqli_fetch_assoc($resulta);
		//============
		$resulta = mysqli_query($con,$sqla) or die(mysqli_error($con));
...
//==================
	...
	//$Regimen->addChild("SwitchIndicator", "false");
		...
		include './mandate_/lidh2.php';
		$sql="SELECT visitdate as DateRegimenStarted,DATE_FORMAT(visitdate,'%d') as DateRegimenStartedDD,DATE_FORMAT(visitdate,'%c') as DateRegimenStartedMM,DATE_FORMAT(visitdate,'%Y') as DateRegimenStartedYYYY FROM pharmacy where pepid='$row[pepid]' AND drugname1='$row1[drugname1]' AND drugname1!=''  and visitdate !='0000-00-00' and pharmdispensedate !='0000-00-00' AND visitdate > '$enroldate' group by visitdate order by visitdate ASC LIMIT 1";
		$result=mysqli_query($con,$sql);
		$info1=mysqli_fetch_assoc($result);
...
ELSE '30' END as PrescribedRegimenDurationCTXpharm
FROM pharmacy 
where pepid='$row[pepid]' and (lower(oidrug) like '%ctx%' or lower(oidrug) like '%co-trim%' or lower(oidrug) like '%cotrim%') 
AND visitdate > '$enroldate'
group by visitdate
order by visitdate DESC LIMIT 1";
		$resultb=mysqli_query($con,$sqlb);
