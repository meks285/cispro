...
if($repmonth=='1' && $repyear==2007 ) {$rtime = strtotime('1/31/2007'); $rdate=date('Y/m/d',$rtime);} 
	...
	//$formerdate = strtotime('$rtime -1 months');
	$formerdate = date("Y/m/d", strtotime("$rdate -1 months")); 
	$cohortdate1 = date("Y/m/d", strtotime("$rdate -12 months")); 
	$cohortdate2 = date("Y/m/d", strtotime("$rdate -24 months")); 
