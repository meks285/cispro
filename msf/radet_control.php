...
<tr>
<td>
<select name="radet_year" style="width:120px; height:20px; float:left">
...
<td><input type="date" name="refdate" id="refdate" required="required" placeholder="YYYY-MM-DD" style="width:120px; height:10px; float:left"/>
</td>
</tr>
<tr>
<td><input type="text" name="daysinterval" id="daysinterval" required="required" style="width:120px; height:10px; float:left"/>
</td>
</tr>
</table>
