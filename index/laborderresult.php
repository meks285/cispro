...
<label>
<span class="small" style="font-weight:bold">11. Hospital No</span>
</label>
...
<input type="text" name="uniqueid" id="uniqueid" readonly="readonly" value="<?php echo $info['pepid']?>" style="height:10px; width:120px" />
        </fieldset>
         </div>
