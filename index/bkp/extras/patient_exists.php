...
{
$drugcode = mysql_real_escape_string($_POST['pepid']);//Some clean up :)


$check_for_drugcode = mysql_query("SELECT pepid,surname,othernames FROM patient WHERE pepid='$pepid'");
