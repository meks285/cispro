...
<input tabindex="1" type="text" name="val2" id="a2b" onChange="pharmacydrugcode()">
<label id="a5b" style="color:#F00; font-style:italic;"></label>
<input tabindex="disable" type="text" name="drugcode1a" id="drugcode1a" onChange="update11();" style="color:#F00; font-style:italic;" readonly>
<input tabindex="disable" type="text" name="drugcode1b" id="drugcode1b" onChange="update11();" readonly>
<input tabindex="disable" type="text" name="drugcode1c" id="drugcode1c" onChange="update11();" readonly>
<input tabindex="disable" type="text" name="drugcode1d" id="drugcode1d" onChange="update11();" readonly>


  <label>
</label>
<span class="small">Enter Code - 2</span>
<input tabindex="2" type="text" name="val3" id="a2b" onChange="pharmacydrugcode1()">
<label id="a5b" style="color:#F00; font-style:italic;"></label>
<input type="text" name="drugcode2a" id="drugcode2a" onChange="update11();" style="color:#F00; font-style:italic;" readonly>
<input type="text" name="drugcode2b" id="drugcode2b" onChange="update11();" readonly>
<input type="text" name="drugcode2c" id="drugcode2c" onChange="update11();" readonly>
<input type="text" name="drugcode2d" id="drugcode2d" onChange="update11();" readonly>

  <label>
</label>
<span class="small">Enter Code - 3</span>
<input tabindex="3" type="text" name="val4" id="a2b" onChange="pharmacydrugcode2()">
<label id="a5b" style="color:#F00; font-style:italic;"></label>
<input type="text" name="drugcode3a" id="drugcode3a" onChange="update11();" style="color:#F00; font-style:italic;" readonly>
<input type="text" name="drugcode3b" id="drugcode3b" onChange="update11();" readonly>
<input type="text" name="drugcode3c" id="drugcode3c" onChange="update11();" readonly>
<input type="text" name="drugcode3d" id="drugcode3d" onChange="update11();" readonly>
