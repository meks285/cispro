...
<input type="text" name="facname" id="facname" readonly="readonly" value="<?php echo $info['facname']?>" />

<label>Facility Code
</label>
<input type="text" name="faccode" id="faccode" readonly="readonly" value="<?php echo $info['faccode']?>"  /> 
...
<input type="text" name="reportingmonth" id="reportingmonth" readonly="readonly" value="<?php echo $_GET['reportingmonth']; ?>"   />
...
?>" style="width:70%;" onChange="updatesum15a();updatesum15b()" ></div></div></td>
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m517"  disabled="disabled" style="width:70%;"  ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m1217" disabled  style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m1717" disabled value="" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="f517" disabled style="width:70%;" onChange="updatesum15a();updatesum15b()" ></div></div></td>
...
?>" style="width:70%;" onChange="updatesum15a();updatesum15b()" ></div></div></td>
        ...
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m518" disabled readonly style="width:70%;" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m1218" disabled value="<?php echo $info['f1218']?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m1718" disabled value="" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="f518" disabled style="width:70%;" onChange="updatesum15a();updatesum15b()" ></div></div></td>
...
echo mysql_result($result2,0);
?>"  style="width:70%;" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m1219" disabled style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
        </tr>
        <tr>
...
AND EXTRACT(MONTH from c.visitdate) = '$_GET[reportingmonth]'
AND  EXTRACT(YEAR from c.visitdate) = '$_GET[reportingyear]'
AND (tbstatus='Yes' or tbstatus like '%INH%' or tbstatus='Currently on TB treatment')
AND p.currentmedications LIKE '%ART%'
";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
        <td style="background-color:#FFF; padding: 3px;"><div style="margin-right: 3px;"><div style="padding-right: 3px;"><input type="text" name="m1723" value="<?php 
$query2 = "SELECT COUNT(DISTINCT c.pepid) 
FROM  pharmacy C JOIN patient p
ON (c.pepid=p.pepid) 
AND EXTRACT(MONTH from c.visitdate) = '$_GET[reportingmonth]'
