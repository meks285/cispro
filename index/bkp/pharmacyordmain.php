...
<a href="./welcome.php" style="font-weight:bold; color:#2A1FFF; font-size:14px">[MAIN MENU]</a> &nbsp;&nbsp;&nbsp;
...
<form class="well-home span6 form-horizontal" name="form" id="formId" method="get">
...
<td><input tabindex="disable" type="text" name="drugcode1c" id="drugcode1c" onChange="update11();" readonly style="width:30px;height:20px"/></td>
<td><input tabindex="disable" type="text" name="drugcode1d" id="drugcode1d" onChange="update11();" readonly style="width:50px;height:20px"/></td>
<td><input type="text" name="regduration1" id="regduration1"  style="width:30px;height:20px"/></td>
</tr>
<tr>
...
<td><input type="text" name="drugcode2c" id="drugcode2c" onChange="update11();" readonly style="width:30px; height:20px"/>
</td>
<td><input type="text" name="drugcode2d" id="drugcode2d" onChange="update11();" readonly style="width:50px; height:20px"/>
</td>
<td><input type="text" name="regduration2" id="regduration2"  style="width:30px;height:20px"/></td>
</tr>
<tr>
...
<td><input type="text" name="drugcode3c" id="drugcode3c" onChange="update11();" readonly style="width:30px; height:20px"/></td>
<td><input type="text" name="drugcode3d" id="drugcode3d" onChange="update11();" readonly style="width:50px; height:20px"/></td>
<td><input type="text" name="regduration3" id="regduration3"  style="width:30px;height:20px"/></td>
</tr>
</tr>
<tr>
<td><input tabindex="3" type="text" name="val5" id="a2b" onChange="pharmacydrugcode3()" style="width:30px; height:20px"/></td>
<label id="a5b" style="color:#F00; font-style:italic;"></label>
<td><input type="text" name="drugcode4a" id="drugcode4a" onChange="update11();" style="color:#F00; font-style:italic;width:120px; height:20px" readonly></td>
<td><input type="text" name="drugcode4b" id="drugcode4b" onChange="update11();" readonly style="width:120px; height:20px"/></td>
<td><input type="text" name="drugcode4c" id="drugcode4c" onChange="update11();" readonly style="width:30px; height:20px"/></td>
<td><input type="text" name="drugcode4d" id="drugcode4d" onChange="update11();" readonly style="width:50px; height:20px"/></td>
<td><input type="text" name="regduration4" id="regduration4"  style="width:30px;height:20px"/></td>
</tr>
</table>
...
$('#submit').click( function() {
	if($('#patart').prop('checked') == false && $('#patnart').prop('checked') == false&&$('#patopep').prop('checked') == false&&$('#patnopep').prop('checked') == false&&$('#patpmtct').prop('checked') == false){
		alert('Specify ART/Non ART/PEP/PMTCT');
	}
	else if($('#visini').prop('checked') == false && $('#visfoll').prop('checked') == false){
		alert('Specify Initial or Follow up');
	}
	else if($('#visitdate').val() == ''){
		alert('Visit date value missing');
	}
	else if($('#pharmdispensedate').val() == ''){
		alert('Dispense date value missing');
	}
	else{
			var query = $('#formId').serialize();
			var pepid = $('#pepid').val();
        	var url = 'insertpharmtest.php';
        	$.post(url, 
        	query, 
        	function (response) {
