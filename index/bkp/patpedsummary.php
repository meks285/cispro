...
<a href="./pedinitialeval.php" style="font-weight:bold; font-size:14px; color:#555F00;font-family: 'Titillium Web', sans-serif;">Initial Evaluation</a> <br>
</fieldset>
<fieldset style="background-image:url(images/wood_pattern.jpg)">
<a href="./laborderresult.php" style="font-weight:bold; font-size:14px; color:#555F00;font-family: 'Titillium Web', sans-serif;"">Lab</a> <br>
</fieldset>
<fieldset style="background-image:url(images/wood_pattern.jpg)">
...
<fieldset style="background-image:url(images/wood_pattern.jpg)">
<a href="./carecardped.php" style="font-weight:bold; font-size:14px;  color:#555F00;font-family: 'Titillium Web', sans-serif;"">Care Card</a> <br>
</fieldset>
<fieldset style="background-image:url(images/wood_pattern.jpg)">
...
<fieldset style="background-image:url(images/bgnoise_lg.jpg)">
<a href="./patlabview.php" style="font-weight:bold; font-size:14px; color:#2A00FF"">Lab History</a> <br>
</fieldset>
<fieldset style="background-image:url(images/bgnoise_lg.jpg)">
