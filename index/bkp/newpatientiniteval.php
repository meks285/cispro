...
<tr>
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Night Sweats" <?php if (strpos($info['symptomsreview'],'Night Sweats') !== false||strpos($info['symptomsreview'],'sweats') !== false) { echo 'checked'; }?> >Night Sweats </td>
...
<td><input type="checkbox" name="symptomsreview[]" id="symptomsreview" value="Pain (other site)" <?php if (strpos($info['symptomsreview'],'Pain (other site)') !== false||strpos($info['symptomsreview'],'Aches') !== false) { echo 'checked'; }?> >Pain (other site) </td>
...
<table>
<tr>
<td><input type="radio" name="knwnallergy" id="allyes" onchange="allergychk()" />Yes</td>
...
<tr>
<td><input type="checkbox" name="currentmedications[]" id="currentmedications" value="STI" <?php if (strpos($info['currentmedications'],'Others') !== false) { echo 'checked'; }?>>Others</td>
</tr>
</table>
</div>  
     </fieldset> 
...
<label></label>
<tr>
<td><input type="radio" name="planarvtherapy" value="Continue current treatment" <?php if ($info['planarvtherapy']=='Continue current treatment'||$info['plan']=='Stable, continue present management') { echo 'checked'; } ?>>Continue current treatment</td>
...
<tr>
<td><input type="radio" name="planarvtherapy" value="Change treatment" <?php if ($info['planarvtherapy']=='Change treatment'||$info['plan']=='Change in clinical plan:') { echo 'checked'; } ?>>Change treatment(Indicate reason code)</td>
...
<button type="submit" style="alignment-adjust:middle">REGISTER</button>
