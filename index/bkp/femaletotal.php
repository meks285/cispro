...
$result = mysqli_query($con,"select pepid, surname,othernames,sex, DATE_FORMAT(DOB, '%d-%b-%Y') dob from patient where sex='female' order by pepid asc");
