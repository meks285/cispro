...
<a href="./reports.php" style="font-weight:bold; font-size:14px;">REPORTS</a> 
...
<?php if(isset($_GET["buildq"])) echo $_GET["buildq"]; ?>
</textarea>
...
$query = "$buildq";
$result=mysql_query($query) or die("There is an error in your query!");
