...
$result = mysqli_query($con,"select a.pepid,a.surname,a.othernames,a.phoneno,DATE_FORMAT(b.nextapptdate, '%d-%b-%Y') nextapptdate,b.visitdate,b.purpose from patient a JOIN appointment b where a.pepid=b.pepid and b.pepid='$_POST[pepid]'");
