...
$result = mysqli_query($con,"select pepid,age, surname,othernames,sex, DATE_FORMAT(DOB, '%d-%b-%Y') dob from patient order by pepid asc");
...
while($row = mysqli_fetch_array($result))
  {
	  if( $row['age']>14){
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="getpatientforlist.php?pepid=' . $row['pepid'] . '&amp;surname=' . $row['surname'] . '">BROWSE</a></td>';
  ...
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="getpedpatient.php?pepid=' . $row['pepid'] . '&amp;surname=' . $row['surname'] . '">BROWSE</a></td>';
  echo "<td>" . $row['pepid'] . "</td>";
  echo "<td>" . $row['surname'] . "</td>";
  echo "<td>" . $row['othernames'] . "</td>";
  echo "<td>" . $row['dob'] . "</td>";
