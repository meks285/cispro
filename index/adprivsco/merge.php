...
<p style="color:red">WARNING: Make sure the folder "C:\MERGE_CIS" exists and is empty!</p>
...
if ($_GET['merge']) {
  ...
  echo "<br />";
  echo "Export Complete, Check \"C:\MERGE_CIS\" ";
}
?>
...
<br />
<div id="stylized" class="myform">
<p>Merge: Make sure all Merge Export files are in the folder "C:\MERGE_CIS"</p>
