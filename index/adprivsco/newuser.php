...
<table>
<tr>
<td><input type="radio" name="role" value="Super"/>Super User</td>
<td><input type="radio" name="role" value="Admin" />Administrative User</td>
</tr>
<tr>
<td><input type="radio" name="role" value="Data" />Data Entry</td>
