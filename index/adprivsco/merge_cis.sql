...
FROM appointment
INTO OUTFILE 'C:/MERGE_CIS/appointment.csv'
...
FROM audit_trail
INTO OUTFILE 'C:/MERGE_CIS/audit_trail.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM clinicaleval
INTO OUTFILE 'C:/MERGE_CIS/clinicaleval.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM crrirf
INTO OUTFILE 'C:/MERGE_CIS/crrirf.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM forlabcispro
INTO OUTFILE 'C:/MERGE_CIS/forlabcispro.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM interruptions
INTO OUTFILE 'C:/MERGE_CIS/interruptions.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM laboratory
INTO OUTFILE 'C:/MERGE_CIS/laboratory.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM patient
INTO OUTFILE 'C:/MERGE_CIS/patient.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM pharmacy
INTO OUTFILE 'C:/MERGE_CIS/pharmacy.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM subswitch
INTO OUTFILE 'C:/MERGE_CIS/subswitch.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';
...
FROM visit
INTO OUTFILE 'C:/MERGE_CIS/visit.csv'
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n';