...
<p>RESTORE: Confirm that the file restore_database.sql exists at "C:\CiS Pro Restore"</p>
<a href="?run=true">Click to commence the restore process!</a>
<?php
error_reporting(0);
if ($_GET['run']) {
...
<br />
<div id="stylized" class="myform">
<p>Migration: Make sure all FMPro Exports have been converted to .csv of same name @ "C:\FMImp"</p>
<a href="?res=true">Migrate Adult DB</a>
<?php
error_reporting(0);
if ($_GET['res']) {
...
&nbsp;
&nbsp;
<a href="?resped=true">Migrate Ped DB</a>
<?php
error_reporting(0);
if ($_GET['resped']) {
  # This code will run if ?res=true is set.
