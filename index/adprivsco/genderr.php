...
class MyClass{
    public function GetUserInformation(){
		$pepid=$_GET['pepid'];
$query = "SELECT idpatient, pepid,surname,othernames,dob,enroldate,sex
...
<title>CiS Pro - Update</title>

</head>
<div class="tops">
<h1 style="background-color:#0F0;font-weight: 600;    font-family: 'Titillium Web', sans-serif;  position: relative;   
font-size: 32px; line-height: 15px; padding: 15px 15px 15px 15%;    color: #355681;    box-shadow:         
inset 0 0 0 1px rgba(53,86,129, 0.4),         inset 0 0 5px rgba(53,86,129, 0.5),        inset -285px 0 35px white;
    border-radius: 0 10px 0 10px;    background: #fff url(./images/bartoszkosowski.jpg) no-repeat center left;">PATIENT Gender CHANGE:&nbsp;&nbsp;&nbsp; <?php echo $info['pepid']?></h1>
...
<form id="formId" method="post" action="genderrin.php" >
...
<input type="text" name="idpatient" id="idpatient" required="required" readonly value="<?php echo $info['idpatient']?>" style="width:30px; height:10px; font-weight:bold" />
        ...
        <div style="display: table-cell;"> 
        <fieldset style="height:20px; border:none">
<label><span class="small" style="font-weight:bold">Change Sex</span></label>
<table>
<tr>
