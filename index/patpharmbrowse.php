...
<?php  echo '<a href="patpharmview.php?pepid=' . $info['pepid'] . '">[BACK]</a>'; ?>
</div>
<body onLoad="bmicalc()">
<div id="stylized" class="myform">
<form class="well-home span6 form-horizontal" name="form" id="form1" method="POST" action="pharmupdate.php">
...
<td><input tabindex="disable" type="text" name="drugcode1b" id="drugcode1b" value="<?php echo $info['drugdose1']?>"onChange="update11();"  style="width:120px; height:20px"/></td>
<td><input tabindex="disable" type="text" name="drugcode1c" id="drugcode1c" value="<?php echo $info['drugno1']?>" onChange="update11();"  style="width:120px; height:20px"/></td>
<td><input tabindex="disable" type="text" name="drugcode1d" id="drugcode1d" value="<?php echo $info['drugsource1']?>"onChange="update11();"  style="width:120px; height:20px"/></td>
</tr>
<tr>
...
<td><input type="text" name="drugcode2b" id="drugcode2b" value="<?php echo $info['drugdose2']?>" onChange="update11();"  style="width:120px; height:20px"/>
</td>
<td><input type="text" name="drugcode2c" id="drugcode2c" value="<?php echo $info['drugno2']?>" onChange="update11();"  style="width:120px; height:20px"/>
</td>
<td><input type="text" name="drugcode2d" id="drugcode2d" value="<?php echo $info['drugsource2']?>" onChange="update11();"  style="width:120px; height:20px"/>
</td>
</tr>
<tr>
...
<td><input type="text" name="drugcode3b" id="drugcode3b" value="<?php echo $info['drugdose3']?>" onChange="update11();"  style="width:120px; height:20px"/></td>
<td><input type="text" name="drugcode3c" id="drugcode3c" value="<?php echo $info['drugno3']?>" onChange="update11();"  style="width:120px; height:20px"/></td>
<td><input type="text" name="drugcode3d" id="drugcode3d" value="<?php echo $info['drugsource3']?>" onChange="update11();"  style="width:120px; height:20px"/></td>
</tr>
</table>
...
<select name="tbdrug">
	<option value="<?php echo $info['tbdrug']?>"><?php echo $info['tbdrug']?></option> 
