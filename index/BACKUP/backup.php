...
<p>BACKUP: Always check for confirmation at "C:\CiS Pro Backups"</p>
<a href="?run=true">Backup!</a>
<?php
error_reporting(0);
if ($_GET['run']) {
  # This code will run if ?run=true is set.
  shell_exec("C:\wamp\www\apindb\BACKUP\CiSProBackup.bat");
  echo "<br />";
