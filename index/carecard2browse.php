...
<?php  echo '<a href="carecard2view.php?pepid=' . $info['pepid'] . '">[BACK]</a>'; ?>
</div>
<br />
<br />
...
<form id="form" name="form" method="POST" action="carecard2update.php">
<fieldset>
...
<input type="text" name="cotrimdose" value="<?php echo $info['cotrimdose']?>" id="cotrimdoze" style="width:120px; height:10px;"/>
<p></p>
        </fieldset>
         </div>
        <div style="display: table-cell;"> 
