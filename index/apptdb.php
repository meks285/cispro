...
<h1 align="center" style="color:#7F3FAA">CIS Pro: APPOINTMENT DATABASE</h1>
</head>
...
<div class="container">
  <div class="sidebar1">
    <ul class="nav">
      <li><a href="./apptpat.php" style="font-weight:bold">Create Appointment</a></li>
      <li><a href="./apptpatfind.php">Find Patient</a></li>
      <li><a href="./apptall.php">All Appointment</a></li>
      <li><a href="#">|</a></li>
      <li><a href="#">|</a></li>
      <li><a href="#">|</a></li>
      <li><a href="#">|</a></li>
