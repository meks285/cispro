...
<h1 align="center" style="background-color:#0F0">PHARMACY RECORDS FOR PATIENT: <?php echo $_SESSION['pepid']?></h1>
<a href="./Welcome.php" style="font-weight:bold; font-size:14px">MAIN MENU</a>

<div id="stylized" class="myform">
<form id="form" name="form" method="POST" action="patpharmbrowse.php">
<fieldset>
...
<input type="date" name="visitdate" id="visitdate" required class="form_element" autocomplete="off" style="width:120px; height:10px;"/>
