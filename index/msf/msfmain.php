...
WHERE pepid IN (select pepid 
                from patient  
		where lower(ppreviousarvexp) != 'transfer in with records' or prevarvtype is null)
...
AND EXTRACT(MONTH from enroldate) = '$_GET[reportingmonth]'
AND  EXTRACT(YEAR from enroldate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(enroldate , dob)/365) between 1 and 14
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
WHERE pepid IN (select pepid 
                from patient  
		where lower(prevarvtype) != 'transfer in with records' or prevarvtype is null)
AND EXTRACT(MONTH from enroldate) = '$_GET[reportingmonth]'
AND  EXTRACT(YEAR from enroldate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(enroldate , dob)/365) >= 15
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>"  style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
WHERE EXTRACT(MONTH from enroldate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from enroldate) = '$_GET[reportingyear]' 
AND BINARY currentmedications NOT LIKE '%ART%'
...
AND  EXTRACT(YEAR from patienttransoutdate) = '$_GET[reportingyear]' 
AND  BINARY patienttransout= 'PRE-ART'
AND ROUND(DATEDIFF(patienttransoutdate , dob)/365) between 1 and 14
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND  EXTRACT(YEAR from patienttransoutdate) = '$_GET[reportingyear]' 
AND BINARY patienttransout= 'PRE-ART'
AND ROUND(DATEDIFF(patienttransoutdate , dob)/365) >= 15
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND dateartstart IS NULL AND (Patientdied IS NULL or patienttransout IS NULL OR interruptstatus!='Stopped') AND 
visittype IN ('Clinical Evaluation', 'Laboratory Order/Result','Pharmacy Order'))
AND ROUND(DATEDIFF(visitdate , dob)/365) between 1 and 14
AND LOWER(sex)LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND dateartstart IS NULL AND (Patientdied IS NULL or patienttransout IS NULL OR interruptstatus!='Stopped') AND 
visittype IN ('Clinical Evaluation', 'Laboratory Order/Result','Pharmacy Order'))
AND ROUND(DATEDIFF(visitdate , dob)/365) >= 15
AND LOWER(sex)LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND dateartstart IS NULL AND (Patientdied IS NULL or patienttransout IS NULL OR interruptstatus!='Stopped') AND 
visittype IN ('Clinical Evaluation', 'Laboratory Order/Result','Pharmacy Order'))
AND ROUND(DATEDIFF(visitdate , dob)/365,1) between 1 and 14
AND LOWER(sex)LIKE 'f%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND dateartstart IS NULL AND (Patientdied IS NULL or patienttransout IS NULL OR interruptstatus!='Stopped') AND 
visittype IN ('Clinical Evaluation', 'Laboratory Order/Result','Pharmacy Order'))
AND ROUND(DATEDIFF(visitdate , dob)/365,1) >= 15 
AND LOWER(sex)LIKE 'f%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND  EXTRACT(YEAR from dateofdeath) = '$_GET[reportingyear]' 
AND patientdied = 'PRE-ART'
AND ROUND(DATEDIFF(dateofdeath , dob)/365,1) between 1 and 14
AND LOWER(sex)LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND  EXTRACT(YEAR from dateofdeath) = '$_GET[reportingyear]' 
AND patientdied = 'PRE-ART'
AND ROUND(DATEDIFF(dateofdeath , dob)/365,1) >= 15
AND LOWER(sex)LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
where (PEPID, VISITDATE) IN (SELECT a.pepid,min(a.visitdate)
		...
		where a.visitdate is not null 
		and (a.drugname1 != '' or lower(a.patienttype)='art') 
		AND ROUND(DATEDIFF(a.visitdate , dob)/365,1) between 1 and 14
		AND LOWER(b.sex) LIKE 'm%'
		group by a.pepid)
AND EXTRACT(MONTH from visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from visitdate) = '$_GET[reportingyear]'";
...
where (PEPID, VISITDATE) IN (SELECT a.pepid,min(a.visitdate)
		...
		where a.visitdate is not null 
		and (a.drugname1 != '' or lower(a.patienttype)='art') 
		AND ROUND(DATEDIFF(a.visitdate , dob)/365,1) >= 15
		AND LOWER(b.sex) LIKE 'm%'
		group by a.pepid)
AND EXTRACT(MONTH from visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from visitdate) = '$_GET[reportingyear]'";
...
AND  EXTRACT(MONTH from pharmdispensedate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from pharmdispensedate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(pharmdispensedate , dob)/365,1) between 1 and 14
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
WHERE ((drugname1 LIKE  'AZT/3TC/NVP' OR drugname2 LIKE  'AZT/3TC/NVP' OR drugname3 LIKE  'AZT/3TC/NVP' OR drugname4 LIKE  'AZT/3TC/NVP')
OR (drugname1 LIKE  'AZT%3TC%NVP' OR drugname2 LIKE  'AZT%3TC%NVP' OR drugname3 LIKE  'AZT%3TC%NVP' OR drugname4 LIKE  'AZT%3TC%NVP')
OR (drugname1 LIKE  'AZT%3TC%EFV' OR drugname2 LIKE  'AZT%3TC%EFV' OR drugname3 LIKE  'AZT%3TC%EFV' OR drugname4 LIKE  'AZT%3TC%EFVS')
...
OR ((drugname1 LIKE  '%(TDF/FTC)' AND drugname2 LIKE  'EFV') OR (drugname1 LIKE  '%(TDF/FTC)' AND drugname3 LIKE  'EFV') OR (drugname1 LIKE  '%(TDF/FTC)' AND drugname4 LIKE  'EFV')
	...
	OR ((drugname1 LIKE 'TDF' AND drugname2 LIKE 'FTC' AND drugname3 LIKE 'EFV') 
	OR (drugname2 LIKE 'TDF' AND drugname3 LIKE 'FTC' AND drugname1 LIKE 'EFV')
	OR (drugname3 LIKE 'TDF' AND drugname2 LIKE 'FTC' AND drugname1 LIKE 'EFV') 
	OR (drugname3 LIKE 'TDF' AND drugname1 LIKE 'FTC' AND drugname2 LIKE 'EFV')
	OR (drugname2 LIKE 'TDF' AND drugname1 LIKE 'FTC' AND drugname3 LIKE 'EFV')
	OR (drugname1 LIKE 'TDF' AND drugname3 LIKE 'FTC' AND drugname2 LIKE 'EFV'))
OR ((drugname1 LIKE 'TDF' AND drugname2 LIKE '3TC' AND drugname3 LIKE 'NVP') 
	OR (drugname2 LIKE 'TDF' AND drugname3 LIKE '3TC' AND drugname1 LIKE 'NVP')
	OR (drugname3 LIKE 'TDF' AND drugname2 LIKE '3TC' AND drugname1 LIKE 'NVP') 
	OR (drugname3 LIKE 'TDF' AND drugname1 LIKE '3TC' AND drugname2 LIKE 'NVP')
	OR (drugname2 LIKE 'TDF' AND drugname1 LIKE '3TC' AND drugname3 LIKE 'NVP')
	OR (drugname1 LIKE 'TDF' AND drugname3 LIKE '3TC' AND drugname2 LIKE 'NVP'))
OR ((drugname1 LIKE 'AZT' AND drugname2 LIKE '3TC' AND drugname3 LIKE 'NVP') 
	OR (drugname2 LIKE 'AZT' AND drugname3 LIKE '3TC' AND drugname1 LIKE 'NVP')
	OR (drugname3 LIKE 'AZT' AND drugname2 LIKE '3TC' AND drugname1 LIKE 'NVP') 
	OR (drugname3 LIKE 'AZT' AND drugname1 LIKE '3TC' AND drugname2 LIKE 'NVP')
	OR (drugname2 LIKE 'AZT' AND drugname1 LIKE '3TC' AND drugname3 LIKE 'NVP')
	OR (drugname1 LIKE 'AZT' AND drugname3 LIKE '3TC' AND drugname2 LIKE 'NVP'))
OR ((drugname1 LIKE 'AZT' AND drugname2 LIKE '3TC' AND drugname3 LIKE 'ABC') 
	OR (drugname2 LIKE 'AZT' AND drugname3 LIKE '3TC' AND drugname1 LIKE 'ABC')
	OR (drugname3 LIKE 'AZT' AND drugname2 LIKE '3TC' AND drugname1 LIKE 'ABC') 
	OR (drugname3 LIKE 'AZT' AND drugname1 LIKE '3TC' AND drugname2 LIKE 'ABC')
	OR (drugname2 LIKE 'AZT' AND drugname1 LIKE '3TC' AND drugname3 LIKE 'ABC')
	OR (drugname1 LIKE 'AZT' AND drugname3 LIKE '3TC' AND drugname2 LIKE 'ABC'))
)
AND  EXTRACT(MONTH from pharmdispensedate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from pharmdispensedate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(pharmdispensedate , dob)/365,1) >= 15
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
$query2 = "SELECT COUNT(DISTINCT PEPID) 
FROM  `pharmcrirrf` 
WHERE ((drugname1 LIKE  'TDF/FTC/LPV/r' OR drugname2 LIKE  'TDF/FTC/LPV/r' OR drugname3 LIKE  'TDF/FTC/LPV/r' OR drugname4 LIKE  'TDF/FTC/LPV/r')
OR (drugname1 LIKE  'TDF%FTC%LPV/r' OR drugname2 LIKE  'TDF%FTC%LPV/r' OR drugname3 LIKE  'TDF%FTC%LPV/r' OR drugname4 LIKE  'TDF%FTC%LPV/r')
OR (drugname1 LIKE  'TDF/3TC/LPV/r' OR drugname2 LIKE  'TDF/3TC/LPV/r' OR drugname3 LIKE  'TDF/3TC/LPV/r' OR drugname4 LIKE  'TDF/3TC/LPV/r')
OR (drugname1 LIKE  'TDF%3TC%LPV/r' OR drugname2 LIKE  'TDF%3TC%LPV/r' OR drugname3 LIKE  'TDF%3TC%LPV/r' OR drugname4 LIKE  'TDF%3TC%LPV/r')
OR (drugname1 LIKE  'TDF/3TC/ATV/r' OR drugname2 LIKE  'TDF/3TC/ATV/r' OR drugname3 LIKE  'TDF/3TC/ATV/r' OR drugname4 LIKE  'TDF/3TC/ATV/r')
OR (drugname1 LIKE  'TDF%3TC%ATV/r' OR drugname2 LIKE  'TDF%3TC%ATV/r' OR drugname3 LIKE  'TDF%3TC%ATV/r' OR drugname4 LIKE  'TDF%3TC%ATV/r')
OR (drugname1 LIKE  'TDF/FTC/ATV/r' OR drugname2 LIKE  'TDF/FTC/ATV/r' OR drugname3 LIKE  'TDF/FTC/ATV/r' OR drugname4 LIKE  'TDF/FTC/ATV/r')
OR (drugname1 LIKE  'TDF%FTC%ATV/r' OR drugname2 LIKE  'TDF%FTC%ATV/r' OR drugname3 LIKE  'TDF%FTC%ATV/r' OR drugname4 LIKE  'TDF%FTC%ATV/r')
OR ((drugname1 LIKE  '%(TDF/FTC)' AND drugname2 LIKE  'LPV/r') OR (drugname1 LIKE  '%(TDF/FTC)' AND drugname3 LIKE  'LPV/r') OR (drugname1 LIKE  '%(TDF/FTC)' AND drugname4 LIKE  'LPV/r')
...
OR	((drugname1 LIKE  'CBV%(AZT/3TC)' AND drugname2 LIKE  'LPV/r') OR (drugname1 LIKE  'CBV%(AZT/3TC)' AND drugname3 LIKE  'LPV/r') OR (drugname1 LIKE  'CBV%(AZT/3TC)' AND drugname4 LIKE  'LPV/r')
 	OR (drugname2 LIKE  'CBV%(AZT/3TC)' AND drugname1 LIKE  'LPV/r') OR (drugname2 LIKE  'CBV%(AZT/3TC)' AND drugname3 LIKE  'LPV/r') OR (drugname2 LIKE  'CBV%(AZT/3TC)' AND drugname4 LIKE  'LPV/r')
  	OR (drugname3 LIKE  'CBV%(AZT/3TC)' AND drugname1 LIKE  'LPV/r') OR (drugname3 LIKE  'CBV%(AZT/3TC)' AND drugname2 LIKE  'LPV/r') OR (drugname3 LIKE  'CBV%(AZT/3TC)' AND drugname4 LIKE  'LPV/r')
  	OR (drugname4 LIKE  'CBV%(AZT/3TC)' AND drugname1 LIKE  'LPV/r') OR (drugname4 LIKE  'CBV%(AZT/3TC)' AND drugname2 LIKE  'LPV/r') OR (drugname4 LIKE  'CBV%(AZT/3TC)' AND drugname3 LIKE  'LPV/r'))
	OR ((drugname1 = 'TDF' AND drugname2 = 'FTC' AND drugname3 = 'LPV/r') 
	OR (drugname2 = 'TDF' AND drugname3 = 'FTC' AND drugname1 = 'LPV/r')
	OR (drugname3 = 'TDF' AND drugname2 = 'FTC' AND drugname1 = 'LPV/r') 
	OR (drugname3 = 'TDF' AND drugname1 = 'FTC' AND drugname2 = 'LPV/r')
	OR (drugname2 = 'TDF' AND drugname1 = 'FTC' AND drugname3 = 'LPV/r')
	OR (drugname1 = 'TDF' AND drugname3 = 'FTC' AND drugname2 = 'LPV/r'))
OR ((drugname1 = 'TDF' AND drugname2 = '3TC' AND drugname3 = 'LPV/r') 
	OR (drugname2 = 'TDF' AND drugname3 = '3TC' AND drugname1 = 'LPV/r')
	OR (drugname3 = 'TDF' AND drugname2 = '3TC' AND drugname1 = 'LPV/r') 
	OR (drugname3 = 'TDF' AND drugname1 = '3TC' AND drugname2 = 'LPV/r')
	OR (drugname2 = 'TDF' AND drugname1 = '3TC' AND drugname3 = 'LPV/r')
	OR (drugname1 = 'TDF' AND drugname3 = '3TC' AND drugname2 = 'LPV/r'))
OR ((drugname1 = 'TDF' AND drugname2 = 'FTC' AND drugname3 = 'ATV/r') 
	OR (drugname2 = 'TDF' AND drugname3 = 'FTC' AND drugname1 = 'ATV/r')
	OR (drugname3 = 'TDF' AND drugname2 = 'FTC' AND drugname1 = 'ATV/r') 
	OR (drugname3 = 'TDF' AND drugname1 = 'FTC' AND drugname2 = 'ATV/r')
	OR (drugname2 = 'TDF' AND drugname1 = 'FTC' AND drugname3 = 'ATV/r')
	OR (drugname1 = 'TDF' AND drugname3 = 'FTC' AND drugname2 = 'ATV/r'))
OR ((drugname1 = 'TDF' AND drugname2 = '3TC' AND drugname3 = 'ATV/r') 
	OR (drugname2 = 'TDF' AND drugname3 = '3TC' AND drugname1 = 'ATV/r')
	OR (drugname3 = 'TDF' AND drugname2 = '3TC' AND drugname1 = 'ATV/r') 
	OR (drugname3 = 'TDF' AND drugname1 = '3TC' AND drugname2 = 'ATV/r')
	OR (drugname2 = 'TDF' AND drugname1 = '3TC' AND drugname3 = 'ATV/r')
	OR (drugname1 = 'TDF' AND drugname3 = '3TC' AND drugname2 = 'ATV/r'))
OR ((drugname1 = 'AZT' AND drugname2 = '3TC' AND drugname3 = 'ATV/r') 
	OR (drugname2 = 'AZT' AND drugname3 = '3TC' AND drugname1 = 'ATV/r')
	OR (drugname3 = 'AZT' AND drugname2 = '3TC' AND drugname1 = 'ATV/r') 
	OR (drugname3 = 'AZT' AND drugname1 = '3TC' AND drugname2 = 'ATV/r')
	OR (drugname2 = 'AZT' AND drugname1 = '3TC' AND drugname3 = 'ATV/r')
	OR (drugname1 = 'AZT' AND drugname3 = '3TC' AND drugname2 = 'ATV/r')))
AND  EXTRACT(MONTH from pharmdispensedate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from pharmdispensedate) = '$_GET[reportingyear]'
AND ROUND(DATEDIFF(pharmdispensedate , dob)/365,1) >= 15
AND LOWER(sex) LIKE 'm%'";
...
AND  EXTRACT(YEAR from enroldate) = '$_GET[reportingyear]' 
AND enroldate IS NOT NULL
AND ROUND(DATEDIFF(enroldate , dob)/365,1) between 1 and 14
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
$query2 = "SELECT COUNT(pepid) 
FROM  `patient` 
WHERE prevarvtype = 'Transfer in with records' AND BINARY currentmedications LIKE '%ART%'
AND EXTRACT(MONTH from enroldate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from enroldate) = '$_GET[reportingyear]' 
AND enroldate IS NOT NULL
AND ROUND(DATEDIFF(enroldate , dob)/365,1) >= 15 
AND LOWER(sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND  EXTRACT(YEAR from interruptions.interrdate) = '$_GET[reportingyear]' 
AND interruptions.interrdate IS NOT NULL
AND ROUND(DATEDIFF(interruptions.interrdate , dob)/365,1) between 1 and 14
AND LOWER(patient.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND  EXTRACT(YEAR from interruptions.interrdate) = '$_GET[reportingyear]' 
AND interruptions.interrdate IS NOT NULL
AND ROUND(DATEDIFF(interruptions.interrdate , dob)/365,1) >= 15
AND LOWER(patient.sex) LIKE 'm%'";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
and PATIENT.PEPID NOT IN ( SELECT DISTINCT PATIENT.PEPID 
    ...
    AND pharmacy.pharmdispensedate <= '$rdate'
AND ((pharmacy.pharmdispensedate IS NOT NULL OR pharmacy.pharmdispensedate !=''))
AND ROUND(DATEDIFF(pharmacy.pharmdispensedate , dob)/365,1) between 1 and 14
AND LOWER(patient.sex) LIKE 'm%')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
and PATIENT.PEPID NOT IN ( SELECT DISTINCT PATIENT.PEPID 
    ...
    AND pharmacy.pharmdispensedate <= '$rdate'
AND ((pharmacy.pharmdispensedate IS NOT NULL OR pharmacy.pharmdispensedate !=''))
AND ROUND(DATEDIFF(pharmacy.pharmdispensedate , dob)/365,1) >= 15 
AND LOWER(patient.sex) LIKE 'm%')";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
?>" style="width:70%;" onChange="endbalcalc1()" ></div></div></td>
...
AND EXTRACT(MONTH from patienttransoutdate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from patienttransoutdate) = '$_GET[reportingyear]' 
AND ROUND(DATEDIFF(patienttransoutdate , dob)/365,1) between 1 and 14
AND LOWER(sex) LIKE 'm%'
";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
AND EXTRACT(MONTH from patienttransoutdate) = '$_GET[reportingmonth]' 
AND  EXTRACT(YEAR from patienttransoutdate) = '$_GET[reportingyear]' 
AND ROUND(DATEDIFF(patienttransoutdate , dob)/365,1) >= 15
AND LOWER(sex) LIKE 'm%'
";
$result2 = mysql_query($query2,$con);
echo mysql_result($result2,0);
...
ON(patient.pepid=pharmacy.pepid)
WHERE ((interruptions.interruptstatus = 'Lost' OR interruptions.interruptstatus = 'Stopped') AND ((interruptions.interrdate IS NOT NULL OR interruptions.interrdate !='') )
AND ROUND(DATEDIFF(interruptions.restartdate , dob)/365,1) between 1 and 14
      AND EXTRACT(MONTH from interruptions.restartdate) = '$_GET[reportingmonth]'
      AND EXTRACT(YEAR from interruptions.restartdate) = '$_GET[reportingyear]' 
      AND LOWER(patient.sex) LIKE 'm%')
OR ((patient.dateartstart IS NOT NULL or patient.dateartstart !='')
...
ON(patient.pepid=pharmacy.pepid)
WHERE ((interruptions.interruptstatus = 'Lost' OR interruptions.interruptstatus = 'Stopped') AND ((interruptions.interrdate IS NOT NULL OR interruptions.interrdate !='') )
AND ROUND(DATEDIFF(interruptions.restartdate , dob)/365,1) >= 15
      AND EXTRACT(MONTH from interruptions.restartdate) = '$_GET[reportingmonth]'
      AND EXTRACT(YEAR from interruptions.restartdate) = '$_GET[reportingyear]' 
      AND LOWER(patient.sex) LIKE 'm%')
OR ((patient.dateartstart IS NOT NULL or patient.dateartstart !='')
...
where (PEPID, VISITDATE) IN (SELECT a.pepid,min(a.visitdate)
		...
		where a.visitdate is not null 
		and (a.drugname1 != '' or lower(a.patienttype)='art') 
		AND ROUND(DATEDIFF(a.visitdate , b.dob)/365,1) >=15
		AND LOWER(b.sex) LIKE 'f%'
		group by a.pepid)
AND lower(pregyn) = 'yes'
AND EXTRACT(MONTH from visitdate) = '$_GET[reportingmonth]' 
...
where (PEPID, VISITDATE) IN (SELECT a.pepid,min(a.visitdate)
		...
		and (a.tbstatus != '' or a.tbstatus is not null) 
		group by a.pepid)
AND EXTRACT(MONTH from visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from visitdate) = '$_GET[reportingyear]'
";
...
where (PEPID, VISITDATE) IN (SELECT a.pepid,min(a.visitdate)
		...
		where a.visitdate is not null 
		AND BINARY b.currentmedications LIKE '%ART%'
		and a.tbdrug LIKE '%CTX%' 
		AND ROUND(DATEDIFF(a.visitdate , b.dob)/365,1) between 1 and 14
		AND lower(sex) LIKE 'm%'
		group by a.pepid)
AND EXTRACT(MONTH from visitdate) = '$_GET[reportingmonth]' 
AND EXTRACT(YEAR from visitdate) = '$_GET[reportingyear]'
