...
<input type="text" name="pepid" id="pepid" required="required" maxlength="10" placeholder="Required" onchange="adtpepid()" style="width:120px; height:10px;font-weight:bold" />
