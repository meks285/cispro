...
<fieldset>
<legend style="font-weight:bold; font-size:11px">19. Symptoms Review</legend>
...
<td><input type="checkbox" name="riskfactors[]" id="riskfactors" value="Blood Transfusion" <?php if (strpos($info['riskfactors'],'Blood Transfusion') !== false||strpos($info['riskfactors'],'Transfusion') !== false) { echo 'checked'; }?> >Blood Transfusion </td>
...
<td><input type="checkbox" name="riskfactors[]" id="riskfactors" value="IDU" <?php if (strpos($info['riskfactors'],'IDU') !== false||strpos($info['riskfactors'],'IVDU') !== false) { echo 'checked'; }?> >IDU </td>
</tr>
</table>
</fieldset>
     </fieldset>
...
<tr>
<td><input type="radio" name="serviceentry" value="OPD" <?php if ($info['serviceentry']=='OPD'||$info['serviceentry']=='GOPD') { echo 'checked'; } ?>/>OPD</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="HCT" <?php if ($info['serviceentry']=='HCT'||$info['serviceentry']=='VCT') { echo 'checked'; } ?>/>HCT</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="HBC" <?php if ($info['serviceentry']=='HBC') { echo 'checked'; } ?>/>HBC</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="Private" <?php if ($info['serviceentry']=='Private'||$info['serviceentry']=='PRIVATE HOSPITAL') { echo 'checked'; } ?>/>Private</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="TB" <?php if ($info['serviceentry']=='TB'||$info['serviceentry']=='TB Service') { echo 'checked'; } ?>/>TB</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="Ward" <?php if ($info['serviceentry']=='Ward') { echo 'checked'; } ?>/>Ward</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="Casualty" <?php if ($info['serviceentry']=='Casualty'||$info['serviceentry']=='CASUALTY') { echo 'checked'; } ?>/>Casualty</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="Public" <?php if ($info['serviceentry']=='Public'||$info['serviceentry']=='PUBLIC HEALTH CENTER') { echo 'checked'; } ?>/>Public</td>
</tr>
<tr>
<td><input type="radio" name="serviceentry" value="ANC/PMTCT" <?php if ($info['serviceentry']=='ANC/PMTCT'||$info['serviceentry']=='ANC'||$info['serviceentry']=='MTC') { echo 'checked'; } ?>/>ANC/PMTCT</td>
</tr>
<tr>
...
<td><input type="checkbox" name="plan[]" id="plan" value="TB Screening" <?php if (strpos($info['plan'],'TB Screening') !== false||strpos($info['plan'],'DOTS') !== false) { echo 'checked'; }?>/>TB Screening</td>
