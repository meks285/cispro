...
<a href="./msf/msfreports.php" style="font-weight:bold; font-size:14px;">MONTHLY SUMM REPORTS</a> 
...
<tr>
<td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="./facsummary.php" style="font-weight:bold; font-size:14px"><img style="border:0;" src="images/facsum.png" alt="Summary" width="200" height="100"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./totalpatientlist.php" style="font-weight:bold; font-size:14px"><img style="border:0;" src="images/paclist.png" alt="Patient list" width="200" height="100"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</td>
<td>
<a href="./crrirf/newcrirrf.php" style="font-weight:bold; font-size:14px"><img style="border:0;" src="images/crrirf.png" alt="CRRIRF" width="200" height="100"></a>
</td>
</tr>
<tr>
<td>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="./drawable_graphs.php" style="font-weight:bold; font-size:14px"><img style="border:0;" src="images/graph.png" alt="GRAPHS" width="200" height="100"></a>
</td>
<td>
<a href="./query_builder.php" style="font-weight:bold; font-size:14px"><img style="border:0;" src="images/queryb.png" alt="QUERY BUILDER" width="200" height="100"></a>
</td>
<td>
<a href="./msf/CQIreports.php" style="font-weight:bold; font-size:14px"><img style="border:0;" src="images/queryb.png" alt="QUERY BUILDER" width="200" height="100"></a>
</td>
</tr>
</table>
</form>
