...
$result = mysqli_query($con,"SELECT pepid,visitdate,artstatus,MAX( cd4 ) AS cd4,MAX( CD4_per ) AS CD4_per, MAX( viral_load ) AS viral_load, MAX( pregnancy ) AS pregnancy,MAX( Malaria_smear ) AS Malaria_smear,MAX( Lymphocytes ) AS Lymphocytes,
...
while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo '<td><a style="color:blue" href="labresultbrowseadt.php?visitdate=' . $row['visitdate'] . '&amp;pepid=' . $row['pepid'] . '&amp;username=' . $_GET['username'] . '">Browse</a></td>';
