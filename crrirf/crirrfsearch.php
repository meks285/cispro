...
$result = mysqli_query($con,"SELECT DATE_FORMAT(reportstart, '%d-%b-%Y') reportstart, DATE_FORMAT(reportend, '%d-%b-%Y') reportend,reportstart as rep1,reportend as rep2
FROM crrirf
order by id desc");
...
while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo '<td style="color:blue; padding: 3px;"><a href="getcrirrf.php?reportstart=' . $row['rep1'] . '&amp;reportend=' . $row['rep2'] . '">Click</a></td>';
  echo "<td>" . $row['reportstart'] . "</td>";
  echo "<td>" . $row['reportend'] . "</td>";
  echo "</tr>";
  }
echo "</table>";
echo "<br>";

echo "Total CRRIRF reports: ".$num;
