...
<?php  echo '<a style="color:blue" href="patlabviewadt.php?pepid=' . $info['pepid'] . '&username='.$_GET['username'].'">[BACK]</a>'; ?>
...
<form id="form" name="form" onkeypress="return event.keyCode != 13;" method="POST" action="insertlaborderresultsadt.php">
<br />
