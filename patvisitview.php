...
$result = mysqli_query($con,"SELECT visitid,pepid, DATE_FORMAT(visitdate, '%d-%b-%Y') visitdate, visittype FROM visit WHERE pepid='$_SESSION[pepid]' order by visitid");
...
while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo '<td><a href="patvisitbrowse.php?visitdate=' . $row['visitdate'] . '&amp;id=' . $row['visitid'] . '&amp;username=' . $_GET['username'] . '">Browse</a></td>';
