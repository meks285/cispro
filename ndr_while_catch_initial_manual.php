...
WHEN 'BU' THEN 'Bingham University Teaching Hospital (BUTH), Jos'
...
AND visitdate > '2017-01-31' group by visitdate order by visitdate ASC LIMIT 1";
...
WHEN 'WBC Diff' THEN '82'
ELSE '' END)!='' 
AND visitdate > '2017-01-31' group by visitdate,tests order by visitdate ASC LIMIT 1";
		//$resulta=mysqli_query($con,$sqla);
		//$info1a=mysqli_fetch_assoc($resulta);
		//============
