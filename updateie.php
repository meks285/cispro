...
if(isset($_POST['address'])){ $address = $_POST['address'];include './mandate_/lidh.php'; $address=mysqli_real_escape_string($con,$address);}  else {$address = "";}
if(isset($_POST['nokaddr'])){ $nokaddr = $_POST['nokaddr'];include './mandate_/lidh.php'; $nokaddr=mysqli_real_escape_string($con,$nokaddr);}  else {$nokaddr = "";}
if(isset($_POST['addrlga'])){$addrlga = $_POST['addrlga']; include './mandate_/lidh.php';$addrlga=mysqli_real_escape_string($con,$addrlga);}  else {$addrlga = "";}
if(isset($_POST['maritalstatus'])){$maritalstatus  = $_POST['maritalstatus'];include './mandate_/lidh.php'; $maritalstatus =mysqli_real_escape_string($con,$maritalstatus );}  else {$maritalstatus  = "";}
if(isset($_POST['educationallevel'])){$educationallevel  = $_POST['educationallevel'];include './mandate_/lidh.php'; $educationallevel =mysqli_real_escape_string($con,$educationallevel );}  else {$educationallevel  = "";}
if(isset($_POST['jobstatus'])){$jobstatus = $_POST['jobstatus'];include './mandate_/lidh.php'; $jobstatus=mysqli_real_escape_string($con,$jobstatus);}  else {$jobstatus = "";}
if(isset($_POST['addrwardvillage'])){ $addrwardvillage = $_POST['addrwardvillage'];include './mandate_/lidh.php'; $addrwardvillage=mysqli_real_escape_string($con,$addrwardvillage);}  else {$addrwardvillage = "";}
if(isset($_POST['nokwardvillage'])){ $nokwardvillage = $_POST['nokwardvillage'];include './mandate_/lidh.php'; $nokwardvillage=mysqli_real_escape_string($con,$nokwardvillage);}  else {$nokwardvillage = "";}
...
if(isset($_POST['otherspec'])) {$otherspec=$_POST['otherspec'];}else {$otherspec="";}
if(isset($_POST['currentlybreastf'])) {$currentlybreastf=$_POST['currentlybreastf'];}else {$currentlybreastf="";}
if(isset($_POST['patacc_tb'])) {$patacc_tb=$_POST['patacc_tb'];}else {$patacc_tb="";}

// New additions
if(isset($_POST['plantbs'])) {$plantbs =$_POST['plantbs'];}else {$plantbs ="";}
if(isset($_POST['whostage'])) {$whostage=$_POST['whostage'];}else {$whostage="";}
if(isset($_POST['trtmtstopreason'])) {$trtmtstopreason=$_POST['trtmtstopreason'];}else {$trtmtstopreason="";}
if(isset($_POST['trtmtstopduration'])) {$trtmtstopduration=$_POST['trtmtstopduration'];}else {$trtmtstopduration="";}
if(isset($_POST['trtmtstopdate'])) {$trtmtstopdate=$_POST['trtmtstopdate'];}else {$trtmtstopdate="";}
if(isset($_POST['trtmtinterreason'])) {$trtmtinterreason=$_POST['trtmtinterreason'];}else {$trtmtinterreason="";}
if(isset($_POST['trtmtinterduration'])) {$trtmtinterduration=$_POST['trtmtinterduration'];}else {$trtmtinterduration="";}
if(isset($_POST['trtmtinterdate'])) {$trtmtinterdate=$_POST['trtmtinterdate'];}else {$trtmtinterdate="";}
if(isset($_POST['stopadhcode'])) {$stopadhcode=$_POST['stopadhcode'];}else {$stopadhcode="";}
if(isset($_POST['interradhcode'])) {$interradhcode=$_POST['interradhcode'];}else {$interradhcode="";}
if(isset($_POST['missedadhcode'])) {$missedadhcode=$_POST['missedadhcode'];}else {$missedadhcode="";}
if(isset($_POST['missadhreason'])) {$missadhreason=$_POST['missadhreason'];}else {$missadhreason="";}
if(isset($_POST['prevarvtype'])) {$prevarvtype=$_POST['prevarvtype'];}else {$prevarvtype="";}
...
if(isset($_POST['lastmenstrualperiod'])) {$lastmenstrualperiod=$_POST['lastmenstrualperiod'];}else {$lastmenstrualperiod="";}
if(isset($_POST['nokrelationship'])) {$nokrelationship=$_POST['nokrelationship'];}else {$nokrelationship="";}
...
$sql="UPDATE patient 
   ...
   prevarvtype='$prevarvtype',
   currentmedications='$currentmedications',
   serviceentry='$serviceentry',
   adherenceyn='$adherenceyn',
   missedadh3daysyn='$missedadh3daysyn',
   missadhreason='$missadhreason',
   missedadhcode='$missedadhcode',
   interradhcode='$interradhcode',
   stopadhcode='$stopadhcode',
   trtmtinterruptionyn='$trtmtinterruptionyn',
   trtmtinterdate='$trtmtinterdate',
   trtmtinterduration='$trtmtinterduration',
   trtmtinterreason='$trtmtinterreason',
   trtmtstopyn='$trtmtstopyn',
   trtmtstopdate='$trtmtstopdate',
   trtmtstopduration='$trtmtstopduration',
   trtmtstopreason='$trtmtstopreason',
   ...
   patacc_tb='$patacc_tb',
   currentlybreastf='$currentlybreastf',
   otherspec='$otherspec',
   fac_location=(select state from facility limit 1),
   fac_location_lga=(select lga from facility limit 1)
