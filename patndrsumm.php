...
FROM patient WHERE idpatient = '$username'";
...
$result = mysqli_query($con,"SELECT *
FROM (select pharmacyid, pepid, DATE_FORMAT(visitdate, '%d-%b-%Y') visitdate, CONCAT(`drugname1`,'/',`drugname2`,'/',`drugname3`) as regimen,DATE_FORMAT(pharmdispensedate, '%d-%b-%Y') dispensedate FROM pharmacy
 WHERE pepid='$_GET[pepid]' 
