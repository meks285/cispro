...
<?php
echo '<a href="dtentryportpharm.php?username='.$_GET['userid'].'">[MAIN MENU]</a>&nbsp; &nbsp; &nbsp; &nbsp;'; 
?>
<?php  echo '<a href="patpharmviewph.php?pepid=' . $info['pepid'] . '&role=Pharm&userid=' . $_GET['userid'] . '">[BACK]</a>'; ?>
</div>
<body onLoad="bmicalc()">
<div id="stylized" class="myform">
<form class="well-home span6 form-horizontal" name="form" onkeypress="return event.keyCode != 13;" id="form1" method="POST" action="pharmupdateph.php">
