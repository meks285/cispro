...
<form id="form" name="form" method="POST" action="insertlaborderresultsadt_fm.php">
<br />
...
<input type="text" name="id" id="id" value="<?php echo $info['id']?>" />
