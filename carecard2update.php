...
// =============== code for Submit_input type ================================
    ...
    if(!mysqli_query($con,"UPDATE clinicaleval
SET visitschd='$visitschd',
...
sideeff='$sideeff',
regimen='$regimen',
regadherencea='$regadherencea',
regadherenceb='$regadherenceb',
cotrimdose='$cotrimdose',
cotrimadherencea='$cotrimadherencea',
cotrimadherenceb='$cotrimadherenceb',
inhdose='$inhdose',
inhadherencea='$inhadherencea',
inhadherenceb='$inhadherenceb',
otherdrugs='$otherdrugs',
vlscheduled='$vlscheduled',
cd4scheduled='$cd4scheduled',
...
visitdate='$visitdate',
tbdose='$tbdose',
tbadherencea='$tbadherencea',
tbadherenceb='$tbadherenceb',
otherregimen='$otherregimen',
cd4value='$cd4value',
vlvalue='$vlvalue',
otherdiag='$otherdiag'
where clinicevalid='$_POST[clinicevalid]'"))
...
$sql="INSERT into AUDIT_TRAIL (server_name,user_name,action) VALUES('$_SERVER[REMOTE_ADDR]','$_SESSION[login_id]','NEW - Care Card.: $_POST[pepid] - $_POST[visitdate]')";
	...
	if ( mysqli_affected_rows($con) >= 1 )
{
		{
	include './mandate_/lidhX.php';
$sql="INSERT into AUDIT_TRAIL (server_name,user_name,action) VALUES('$_SERVER[REMOTE_ADDR]','$_SESSION[login_id]','UPDATE - Care Card.: $_POST[pepid] - $_POST[visitdate]')";
$result=mysqli_query($con,$sql);
}
