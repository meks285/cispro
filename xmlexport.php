...
ELSE '' END AS CodeDescTxt_OI,a.nextappointmentdate as NextAppointmentDate,CASE d.drugname1 
...
from patient a JOIN (select * from clinicaleval where pepid='$_POST[pepid]' order by visitdate ASC LIMIT 1) b
ON (a.pepid=b.pepid)
JOIN (select * from laboratory where pepid='$_POST[pepid]' and tests='CD4' order by visitdate ASC LIMIT 1) c
ON (a.pepid=c.pepid)
JOIN (select * from pharmacy where pepid='$_POST[pepid]' order by visitdate ASC LIMIT 1) d
ON (a.pepid=d.pepid)";
