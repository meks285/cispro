...
$.ajax({  //Make the Ajax Request
    type: "POST",  
    url: "pmtct_existsz.php",  //file name
...
<form id="form" name="form" method="GET" action="./pmtct/exposedinfantbrowsez.php">
<h2>ENTER SEARCH CRITERIA and Click the BUTTON</h2>
<fieldset>
<legend style="font-weight:bold; font-size:11px">Patient EID ID:</legend>
<div class="style_form">
<label for="pepid">EID ID
</label>
