...
if(isset($_POST['hospitalid'])){ $hospitalid = $_POST['hospitalid']; $address=mysql_real_escape_string($hospitalid);} 
if(isset($_POST['pchildliveswith'])){ $pchildliveswith = $_POST['pchildliveswith']; $address=mysql_real_escape_string($pchildliveswith);} 
...
if(isset($_POST['pcaregiversrelationshipstatus'])) {$pcaregiversrelationshipstatus=$_POST['pcaregiversrelationshipstatus'];}else {$pcaregiversrelationshipstatus="";}
?>
...
if(!mysqli_query($con,"UPDATE patient 
   ...
   pchildliveswith='$pchildliveswith'
   WHERE pepid='$pepid'"));
...
{
	header("refresh:3;./todayslists.php?created_on=".$created_on."");  
