...
<a href="./searchentry.php" style="font-weight:bold; font-size:14px">[BACK]</a>
...
$createdate = $_GET['created_on'];
$createdate;
$result = mysqli_query($con,"SELECT pepid,enroldate, surname,othernames,dob,hivposdate, age, sex,created_on
from patient 
where EXTRACT(YEAR FROM DATE(created_on))=EXTRACT(YEAR FROM '$createdate') AND EXTRACT(MONTH FROM DATE(created_on))=EXTRACT(MONTH FROM '$createdate')
