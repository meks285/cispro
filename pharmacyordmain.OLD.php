...
<a href="./welcome.php?username=<?php echo $_GET['username'] ?>" style="font-weight:bold; color:#2A1FFF; font-size:14px">[MAIN MENU]</a> &nbsp;&nbsp;&nbsp;
...
<td><select name="regduration4" id="regduration4" style="height:30px; width:70px">
	<option value="">MTHS</option> 
    <option value="0.25">1 WK</option> 
    <option value="0.5">2 WKS</option>
    <option value="0.75">3 WKS</option>
...
<fieldset style="width:733px; height:80px">
<div  class="check-toolbar">
<tr>
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="INH" >INH</td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="Rifampicin" >Rifampicin</td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="Ethambutol">Ethambutol </td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="Streptomycin Injection">Streptomycin Injection</td><br />
<td><input type="checkbox" name="tbdrug[]" id="tbdrug" value="PZI"  >PZI </td>
</tr>
</table>
</div>
</fieldset>
