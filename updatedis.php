...
if (mysqli_connect_errno())
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
   ...
   if (!empty($_POST["interruptstatus"])){
$pepid = $_POST['pepid'];  
$sql="UPDATE patient 
   SET 
   patienttransout='$_POST[patienttransout]',
   patienttransoutdate='$_POST[patienttransoutdate]',
   facilityrefto='$_POST[facilityrefto]',
   patientdied='$_POST[patientdied]',
   dateofdeath='$_POST[dateofdeath]',
   sourceofdeathinf='$_POST[sourceofdeathinf]',
   drugallergies='$_POST[drugallergies]',
   clinicalstageart='$_POST[clinicalstageart]',
   causeofdeath='$_POST[causeofdeath]'
   WHERE pepid='$pepid';";
 
$sql.="insert into interruptions(pepid,interruptstatus,interrdate,reason,restartdate) values('$_POST[pepid]','$_POST[interruptstatus]','$_POST[interrdate]','$_POST[reason]','$_POST[restartdate]'); ";
...
header('Location: ./discontinuation.php');
}
else {
$pepid = $_POST['pepid'];  
$sql="UPDATE patient 
